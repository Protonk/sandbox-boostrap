...
1. [`book/evidence/graph/concepts/validation/out/experiments/gate-witnesses/witness_results.json`](../../book/graph/concepts/validation/out/experiments/gate-witnesses/witness_results.json)
2. [`book/evidence/graph/concepts/validation/out/experiments/gate-witnesses/forensics/airlock/log_show_primary.minimal_failing.txt`](../../book/graph/concepts/validation/out/experiments/gate-witnesses/forensics/airlock/log_show_primary.minimal_failing.txt)
3. [`book/evidence/graph/concepts/validation/out/experiments/gate-witnesses/forensics/airlock/log_show_primary.passing_neighbor.txt`](../../book/graph/concepts/validation/out/experiments/gate-witnesses/forensics/airlock/log_show_primary.passing_neighbor.txt)
...
Custom/synthetic blobs applied cleanly while some system profiles (notably `airlock`) failed to apply with `EPERM`, which quickly became a practical blocker for runtime harness work (notably the `runtime-checks` corpus trying to treat canonical `sys:*` blobs as runnable probes on this world). See [`book/evidence/experiments/runtime-final-final/suites/runtime-checks/Report.md`](../../book/experiments/runtime-final-final/suites/runtime-checks/Report.md) for the “blocked by apply-stage EPERM” framing in that experiment’s own vocabulary.
...
Raw stderr excerpt (from `book/evidence/experiments/runtime-final-final/suites/gate-witnesses/out/witnesses/airlock/run.json`, `minimal_failing_outcome.raw_stderr`):
...
- Experiment + checked-in witness pairs: [`book/evidence/experiments/runtime-final-final/suites/gate-witnesses/`](../../book/experiments/runtime-final-final/suites/gate-witnesses/)

The current witness corpus is described in [`book/evidence/experiments/runtime-final-final/suites/gate-witnesses/Report.md`](../../book/experiments/runtime-final-final/suites/gate-witnesses/Report.md) and is enforced by validation outputs in:

- [`book/evidence/graph/concepts/validation/out/experiments/gate-witnesses/witness_results.json`](../../book/graph/concepts/validation/out/experiments/gate-witnesses/witness_results.json)
- Forensics directory with compiled blobs + unified-log capture: [`book/evidence/graph/concepts/validation/out/experiments/gate-witnesses/forensics/`](../../book/graph/concepts/validation/out/experiments/gate-witnesses/forensics)
...
- `R = book/evidence/graph/concepts/validation/out/experiments/gate-witnesses/witness_results.json`
- `W = book/evidence/experiments/runtime-final-final/suites/gate-witnesses/out/witnesses/<id>/`
- `F = book/evidence/graph/concepts/validation/out/experiments/gate-witnesses/forensics/<id>/`
...
Concrete excerpt (from `book/evidence/experiments/runtime-final-final/suites/gate-witnesses/out/witnesses/mach_bootstrap_deny_message_send/minimal_failing.sb`):
...
The gate-witnesses micro-variant matrix (`book/evidence/experiments/runtime-final-final/suites/gate-witnesses/out/compile_vs_apply.json`) records a small set of one-edit variants with explicit compile and blob-apply results.
...
Source: `book/evidence/experiments/runtime-final-final/suites/gate-witnesses/out/compile_vs_apply.json` (see `micro_variants[]`).

```json
[
  {
    "id": "base_v2_inner_deny_external_trap",
    "sbpl": "book/evidence/experiments/runtime-final-final/suites/gate-witnesses/out/micro_variants/base_v2_inner_deny_external_trap.sb",
    "apply_blob": {
      "report": {
        "failure_stage": "apply",
  ...
  },
  {
    ...
    "sbpl": "book/evidence/experiments/runtime-final-final/suites/gate-witnesses/out/micro_variants/base_v2_mach_bootstrap_deny_message_send.sb",
    "apply_blob": {
      "report": {
        "failure_stage": "apply",
        "failure_kind": "sandbox_apply_failed",
  ...
  },
  {
    ...
    "sbpl": "book/evidence/experiments/runtime-final-final/suites/gate-witnesses/out/micro_variants/base_v2_mach_bootstrap_allow_only_with_file_write.sb",
    "apply_blob": {
      "report": {
  ...
  },
  {
    ...
    "sbpl": "book/evidence/experiments/runtime-final-final/suites/gate-witnesses/out/micro_variants/base_v1_inner_allow_external_method.sb",
    "apply_blob": {
      "report": {
        "failure_stage": "bootstrap",
        "failure_kind": "bootstrap_deny_process_exec",
...
- codesign “presence” scan for the entitlement key on a small set of system executables: [`book/evidence/experiments/runtime-final-final/suites/gate-witnesses/out/entitlements_scan.json`](../../book/experiments/runtime-final-final/suites/gate-witnesses/out/entitlements_scan.json) (mapped; presence is not causality)
- kernel string presence + xrefs for related strings (brittle/partial, but helps locate likely call sites): [`book/evidence/experiments/runtime-final-final/suites/gate-witnesses/out/message_filter_xrefs.json`](../../book/experiments/runtime-final-final/suites/gate-witnesses/out/message_filter_xrefs.json)
...
- Experiment: [`book/evidence/experiments/runtime-final-final/suites/preflight-blob-digests/`](../../book/experiments/runtime-final-final/suites/preflight-blob-digests/)
- Validation IR consumed by the preflight tool: [`book/evidence/graph/concepts/validation/out/experiments/preflight-blob-digests/blob_digests_ir.json`](../../book/graph/concepts/validation/out/experiments/preflight-blob-digests/blob_digests_ir.json)
- Human-facing digest list (experiment output): [`book/evidence/experiments/runtime-final-final/suites/preflight-blob-digests/out/apply_gate_blob_digests.json`](../../book/experiments/runtime-final-final/suites/preflight-blob-digests/out/apply_gate_blob_digests.json)
...
- Provenance (archived): [`book/evidence/experiments/archive/preflight-index/Report.md`](../../book/experiments/archive/preflight-index/Report.md)
...
- We have not promoted a general structural classifier for `.sb.bin` beyond exact digest match; “structural signal listening” remains explicitly partial/brittle in [`book/evidence/experiments/runtime-final-final/suites/preflight-blob-digests/Report.md`](../../book/experiments/runtime-final-final/suites/preflight-blob-digests/Report.md).
...
- Witness corpus + cause tightening:
  - [`book/evidence/experiments/runtime-final-final/suites/gate-witnesses/Report.md`](../../book/experiments/runtime-final-final/suites/gate-witnesses/Report.md)
  - Validation output: [`book/evidence/graph/concepts/validation/out/experiments/gate-witnesses/witness_results.json`](../../book/graph/concepts/validation/out/experiments/gate-witnesses/witness_results.json)
  - Forensics (compiled blobs + unified logs): [`book/evidence/graph/concepts/validation/out/experiments/gate-witnesses/forensics/`](../../book/graph/concepts/validation/out/experiments/gate-witnesses/forensics)
- `.sb.bin` digest-based avoidance:
  - [`book/evidence/experiments/runtime-final-final/suites/preflight-blob-digests/Report.md`](../../book/experiments/runtime-final-final/suites/preflight-blob-digests/Report.md)
  - Validation IR: [`book/evidence/graph/concepts/validation/out/experiments/preflight-blob-digests/blob_digests_ir.json`](../../book/graph/concepts/validation/out/experiments/preflight-blob-digests/blob_digests_ir.json)
- Repo-wide enterability manifest:
  - [`book/evidence/experiments/archive/preflight-index/Report.md`](../../book/experiments/archive/preflight-index/Report.md)
  - Manifest: [`book/tools/preflight/index/preflight_enterability_manifest.json`](../../book/tools/preflight/index/preflight_enterability_manifest.json)
