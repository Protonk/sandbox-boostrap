...
- Experiment: `book/evidence/experiments/runtime-final-final/suites/sbpl-graph-runtime` (profile `profiles/metafilter_any.sb`).
- Harness: `sandbox_runner` driven by `book/evidence/experiments/runtime-final-final/suites/runtime-checks/run_probes.py`.
...
- Profile: `book/evidence/experiments/runtime-final-final/suites/sbpl-graph-runtime/profiles/metafilter_any.sb`
- Harness: `book/evidence/experiments/runtime-final-final/suites/runtime-checks/run_probes.py`
- Reader helper: `book/evidence/experiments/runtime-final-final/suites/runtime-checks/sandbox_reader` (non-exec probe path)
