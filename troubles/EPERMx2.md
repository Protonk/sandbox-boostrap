...
- [`book/integration/carton/bundle/relationships/mappings/runtime_cuts/scenarios.json`](book/integration/carton/bundle/relationships/mappings/runtime_cuts/scenarios.json) and [`book/integration/carton/bundle/relationships/mappings/runtime_cuts/runtime_story.json`](book/integration/carton/bundle/relationships/mappings/runtime_cuts/runtime_story.json) — mapping-layer slices containing `stderr: "sandbox_apply: Operation not permitted\n"` entries.
