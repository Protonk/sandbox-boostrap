...
- Profiles: shipped blobs from `book/evidence/carton/validation/fixtures/blobs/` (extracted from `/System/Library/Sandbox/Profiles/*.sb.bin` via the extract helper).
