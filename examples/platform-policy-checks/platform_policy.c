...
// policy (evaluated first per guidance/Orientation.md) likely short-circuited
...
int main(void) {
    ...
    printf("\nRemember: platform policy runs before any per-process sandbox (guidance/Orientation.md §2),\n");
