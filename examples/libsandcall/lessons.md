...
- Demonstrates the private APIs described in `guidance/Orientation.md` §3.2; useful for observing how compilation succeeds even when activation (`sandbox_apply`) is refused.
