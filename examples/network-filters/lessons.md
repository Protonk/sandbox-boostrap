...
- Network syscalls map to sandbox operations such as `network-outbound`, with filters for `socket-domain`, `socket-type`, and remote/local addresses (guidance/Appendix.md).
