...
- Watching success/failure against different names shows how service strings become sandbox inputs, matching the operation/filter vocabulary in guidance/Appendix.md.
