...
- `require-any/all/not` are SBPL combinators that compile into specific graph shapes even though the binary format has no explicit metafilter opcode (guidance/Appendix.md §5).
