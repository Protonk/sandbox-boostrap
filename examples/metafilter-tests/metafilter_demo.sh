...
# structure to the graph patterns described in guidance/Appendix.md (metafilters
...
- require-not: flips the sense of the nested filter; in compiled graphs this is
  just control-flow structure, not an explicit NOT opcode (see guidance/Appendix.md).
"
