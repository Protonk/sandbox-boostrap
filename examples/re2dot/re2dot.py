...
This is a pure-Python replacement for the old libMatch-based helper. It parses
the serialized NFA described in Appendix.md (“Regular Expressions and Literal
Tables”) and emits nodes/edges so you can visualize the regex structure that
Seatbelt stores alongside the binary policy graph.
"""
