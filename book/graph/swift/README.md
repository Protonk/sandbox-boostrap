...
- **Inputs:** `book/substrate/Concepts.md`, `book/evidence/graph/concepts/CONCEPT_INVENTORY.md`, `book/graph/concepts/validation/Concept_map.md`, `book/examples/`, and any mapping JSONs you load here explicitly.
- **Outputs:** regenerated `concepts.json`, `concept_map.json`, `concept_text_map.json`, `examples.json`, `strategies.json`, and `validation_report.json` under `book/evidence/graph/concepts/validation/`.
