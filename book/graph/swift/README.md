...
- **Inputs:** `book/substrate/Concepts.md`, `book/evidence/graph/concepts/CONCEPT_INVENTORY.md`, `book/graph/concepts/validation/Concept_map.md`, `book/evidence/graph/mappings/runtime/expectations.json`, and any mapping JSONs you load here explicitly.
