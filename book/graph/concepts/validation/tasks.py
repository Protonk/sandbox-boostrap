...
PLAN = {
    ...
    "lifecycle-extension": [
        ...
        },
        {
            ...
            "run": "book/examples/platform-policy-checks/platform_policy.c",
        ...
        },
        {
            ...
            "run": "book/examples/containers-and-redirects/containers_demo.swift",
        ...
        },
        {
            ...
            "example": "libsandcall",
            "run": "book/examples/libsandcall/run-demo.sh",
