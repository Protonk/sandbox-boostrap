...
STATUS_PATH = ROOT / "book/evidence/graph/concepts/validation/out/sbpl_param_value_matrix/status.json"
...
registry.register(
    ValidationJob(
        ...
        example_command="python -m book.graph.concepts.validation --id structure:sbpl-param-value-matrix",
