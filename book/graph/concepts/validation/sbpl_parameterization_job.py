...
STATUS_PATH = ROOT / "book/evidence/graph/concepts/validation/out/sbpl_parameterization/status.json"
...
registry.register(
    ValidationJob(
        ...
        example_command="python -m book.graph.concepts.validation --id structure:sbpl-parameterization",
