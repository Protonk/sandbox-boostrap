...
Inputs:
- `packet_set.json` in this directory (preferred), or explicit `--packets` args.
...
DEFAULT_PACKET_SET_PATH = SCRIPT_ROOT / "packet_set.json"
DEFAULT_RECEIPT_PATH = SCRIPT_ROOT / "promotion_receipt.json"
DEFAULT_OUT_PATH = SCRIPT_ROOT / "path_canonicalization_map.json"
