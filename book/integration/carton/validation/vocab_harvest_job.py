...
STATUS_PATH = ROOT / "book/evidence/syncretic/validation/out/vocab_status.json"
...
registry.register(
    ValidationJob(
        ...
        example_command="python -m book.integration.carton validate --id vocab:sonoma-14.4.1",
