...
STATUS_PATH = ROOT / "book/evidence/syncretic/validation/out/tag_roles/status.json"
IR_PATH = ROOT / "book/evidence/syncretic/validation/out/tag_roles/ir.json"
...
registry.register(
    ValidationJob(
        ...
        example_command="python -m book.integration.carton validate --job structure:tag_roles",
