...
ENTITLEMENTS_OUT = "book/evidence/syncretic/validation/out/lifecycle/entitlements.json"
EXTENSIONS_OUT = "book/evidence/syncretic/validation/out/lifecycle/extensions_dynamic.md"
...
registry.register(
    registry.ValidationJob(
        ...
        example_command=f"{ENV_ENABLE}=1 python -m book.integration.carton validate --id lifecycle:probes",
    )
)
