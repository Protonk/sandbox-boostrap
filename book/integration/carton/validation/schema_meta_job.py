...
EXPERIMENT_STATUS_DIR = ROOT / "book" / "evidence" / "syncretic" / "validation" / "out" / "experiments"
...
def run_schema_job():
    ...
    payload = {
        ...
        "status": status,
        "host": host,
        "inputs": [rel(STATUS_PATH), "book/evidence/syncretic/validation/out/experiments/*/status.json"],
        "outputs": [],
