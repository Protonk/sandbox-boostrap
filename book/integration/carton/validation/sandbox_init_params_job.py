...
STATUS_PATH = ROOT / "book/evidence/carton/validation/out/experiments/sandbox-init-params/status.json"
...
registry.register(
    ValidationJob(
        ...
        example_command="python -m book.integration.carton validate --experiment sandbox-init-params",
