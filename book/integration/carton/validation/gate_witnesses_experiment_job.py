...
OUT_DIR = ROOT / "book/evidence/syncretic/validation/out/experiments/gate-witnesses"
...
registry.register(
    ValidationJob(
        ...
        example_command="python -m book.integration.carton validate --experiment gate-witnesses",
