...
- **Inputs:** `book/substrate/Concepts.md`, `book/evidence/graph/concepts/CONCEPT_INVENTORY.md`, `book/integration/carton/Concept_map.md`, `book/integration/carton/bundle/relationships/mappings/runtime/expectations.json`, `book/integration/carton/bundle/relationships/inventory/inventory_graph.json`, and any mapping JSONs you load here explicitly.
