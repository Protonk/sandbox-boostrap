...
Compatibility:
- `book/integration/carton/bundle/relationships/mappings/anchors/anchor_filter_map.json` is a lossy, derived view
...
ANCHOR_FIELD2_MAP_PATH = REPO_ROOT / "book/integration/carton/bundle/relationships/mappings/anchors/anchor_field2_map.json"
FILTER_VOCAB_PATH = REPO_ROOT / "book/integration/carton/bundle/relationships/mappings/vocab/filters.json"
OUT_PATH = REPO_ROOT / "book/integration/carton/bundle/relationships/mappings/anchors/anchor_ctx_filter_map.json"
