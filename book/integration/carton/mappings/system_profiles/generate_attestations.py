...
- `book/integration/carton/bundle/relationships/mappings/vocab/{ops,filters}.json`

Outputs:
- `book/integration/carton/bundle/relationships/mappings/system_profiles/attestations.json`
- `book/integration/carton/bundle/relationships/mappings/system_profiles/attestations/*.jsonl` (per-profile rows)
"""
...
def gather_profile_paths() -> Set[Path]:
    paths: Set[Path] = set()
    digests = load_json(REPO_ROOT / "book/integration/carton/bundle/relationships/mappings/system_profiles/digests.json")
...
def main() -> None:
    ...
    anchor_map = load_json(REPO_ROOT / "book/integration/carton/bundle/relationships/mappings/anchors/anchor_filter_map.json")
    tag_layout_hash = tag_layout_tag_set_hash(TAG_LAYOUTS_PATH)
    tag_layouts_file_sha256 = sha256(TAG_LAYOUTS_PATH)
    vocab_ops = load_json(REPO_ROOT / "book/integration/carton/bundle/relationships/mappings/vocab/ops.json")
    vocab_filters = load_json(REPO_ROOT / "book/integration/carton/bundle/relationships/mappings/vocab/filters.json")
    runtime_manifest = load_json(REPO_ROOT / "book/integration/carton/bundle/relationships/mappings/runtime/expectations.json")
    digests = load_json(REPO_ROOT / "book/integration/carton/bundle/relationships/mappings/system_profiles/digests.json")
    ...
    metadata = {
        ...
        "vocab_versions": vocab_versions,
        "runtime_manifest": str(Path("book/integration/carton/bundle/relationships/mappings/runtime/expectations.json")) if runtime_manifest else None,
        "attestation_count": len(attestations),
        "inputs": [
            world_path,
            str(Path("book/integration/carton/bundle/relationships/mappings/system_profiles/digests.json")),
            str(Path("book/integration/carton/bundle/relationships/mappings/anchors/anchor_filter_map.json")),
            str(Path("book/integration/carton/bundle/relationships/mappings/tag_layouts/tag_layouts.json")),
            str(Path("book/integration/carton/bundle/relationships/mappings/vocab/ops.json")),
            str(Path("book/integration/carton/bundle/relationships/mappings/vocab/filters.json")),
            str(Path("book/integration/carton/bundle/relationships/mappings/runtime/expectations.json")),
        ]
