...
- Rerun `book/integration/carton/mappings/runtime/generate_lifecycle.py` after updating lifecycle probes in `book/evidence/carton/validation/out/lifecycle/` to refresh `lifecycle.json` and `lifecycle_traces/`.
