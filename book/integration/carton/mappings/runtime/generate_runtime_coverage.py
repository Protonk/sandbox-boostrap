...
OUT = ROOT / "book/integration/carton/bundle/relationships/mappings/runtime/runtime_coverage.json"
...
def generate(packet_paths: List[Path] | None = None, impact_map_path: Path | None = None) -> Path:
    ...
    story_meta = story.get("meta") or {}
    story_inputs = story_meta.get("inputs") or ["book/integration/carton/bundle/relationships/mappings/runtime_cuts/runtime_story.json"]
