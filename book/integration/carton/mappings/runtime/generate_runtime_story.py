...
Reads the canonical op/scenario mappings from book/integration/carton/bundle/relationships/mappings/runtime_cuts/
...
from book.api.runtime.analysis.mapping import story as rt_story
...
CUT_ROOT = ROOT / "book" / "integration" / "carton" / "bundle" / "relationships" / "mappings" / "runtime_cuts"
