...
from book.tools.sbpl.oracles.network_matrix import run_network_matrix


from book.api import path_utils
def test_sbpl_oracle_network_matrix_matches_experiment_oracle_values():
    root = path_utils.find_repo_root(Path(__file__))
    golden_path = root / "book/evidence/experiments/field2-final-final/libsandbox-encoder/out/network_matrix/oracle_tuples.json"
...
def test_sbpl_oracle_network_matrix_runner_parity():
    root = path_utils.find_repo_root(Path(__file__))
    manifest = root / "book/evidence/experiments/field2-final-final/libsandbox-encoder/sb/network_matrix/MANIFEST.json"
    blob_dir = root / "book/evidence/experiments/field2-final-final/libsandbox-encoder/out/network_matrix"
