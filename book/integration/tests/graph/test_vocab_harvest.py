...
VOCAB_MAPPINGS = ROOT / "book" / "integration" / "carton" / "bundle" / "relationships" / "mappings" / "vocab"
DYLD_LIB_SOURCE = "book/integration/carton/bundle/relationships/mappings/dyld-libs/usr/lib/libsandbox.1.dylib"
