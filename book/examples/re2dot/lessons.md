...
- Inputs should come from profile regex tables as described in `substrate/Appendix.md` (“Regular Expressions and Literal Tables”), not from arbitrary regex formats.
