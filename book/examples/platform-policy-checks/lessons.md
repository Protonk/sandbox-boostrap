...
- Platform rules frequently guard sysctls, Mach services, and SIP-protected paths using filters like `sysctl-name`, `csr`, and `system-attribute` (see substrate/Appendix.md).
