...
```sh
python -m book.api.lifecycle entitlements --out book/graph/concepts/validation/out/lifecycle/entitlements.json
python -m book.api.lifecycle extensions --out book/graph/concepts/validation/out/lifecycle/extensions_dynamic.md
python -m book.api.lifecycle platform-policy --out book/graph/concepts/validation/out/lifecycle/platform.jsonl
python -m book.api.lifecycle containers --out book/graph/concepts/validation/out/lifecycle/containers.json
python -m book.api.lifecycle apply-attempt --out book/graph/concepts/validation/out/lifecycle/apply_attempt.json
```
