...
from book.api.runtime_tools.artifacts import reader as artifact_reader
...
def summarize_ops_from_bundle(
    ...
    *,
    ...
    summary = build_op_runtime_summary(
        ...
        notes="Op-level summary derived from a runtime_tools bundle (decision-stage only when promotable).",
    )
