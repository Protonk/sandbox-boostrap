...
SYSTEM_DIGESTS_REF = Path("book/integration/carton/bundle/relationships/mappings/system_profiles/digests.json")
SYSTEM_STATIC_CHECKS_REF = Path("book/integration/carton/bundle/relationships/mappings/system_profiles/static_checks.json")
SYSTEM_ATTESTATIONS_REF = Path("book/integration/carton/bundle/relationships/mappings/system_profiles/attestations.json")
