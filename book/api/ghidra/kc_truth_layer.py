...
Promoted into the Ghidra/kernel tooling surface; keep this module importable as
`book.api.ghidra.kc_truth_layer`.

Outputs (default under book/evidence/experiments/mac-policy-registration/out):
...
def main() -> int:
    ...
    parser.add_argument("--out-dir", default="book/evidence/experiments/mac-policy-registration/out", help="Output dir.")
    parser.add_argument(
        "--fixups-mode",
