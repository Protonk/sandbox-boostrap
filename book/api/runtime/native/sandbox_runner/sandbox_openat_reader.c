...
/*
 * sandbox_openat_reader: apply SBPL profile from file via sandbox_init, then open
 ...
 *
 * Usage: sandbox_openat_reader <profile.sb> <path>
 */
...
int main(int argc, char *argv[]) {
    ...
    return sandbox_io_read_openat(argv[1], argv[2]);
}
