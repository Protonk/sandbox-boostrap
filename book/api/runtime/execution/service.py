            ...
            results.append(
                {
                    ...
                    "check_type": callout.get("check_type"),
                    "argument": callout.get("argument"),
                    "canonicalization": callout.get("canonicalization"),
                    "canonical_flag_used": callout.get("canonical_flag_used"),
                    "canonical_flag_reason": callout.get("canonical_flag_reason"),
                    "no_report": callout.get("no_report"),
                    "no_report_reason": callout.get("no_report_reason"),
                    "token_status": callout.get("token_status"),
                    "token_mach_kr": callout.get("token_mach_kr"),
                    "rc": callout.get("rc"),
                    "errno": callout.get("errno"),
                    "decision": callout.get("decision"),
                    "error": callout.get("error"),
                }
            )
    _write_json(
        out_path,
