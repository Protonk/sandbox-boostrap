...
Assumptions: macOS 14.4.1 (23E224), Apple Silicon, SIP enabled, `libsandbox.dylib` present. Outputs are the modern graph-based binary blobs described in `substrate/Appendix.md`.
