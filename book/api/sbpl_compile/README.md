...
Assumptions: baseline from `world_id sonoma-14.4.1-23E224-arm64-dyld-2c0602c5 (baseline: book/world/sonoma-14.4.1-23E224-arm64/world-baseline.json)`; `libsandbox.dylib` present. Outputs are the modern graph-based binary blobs described in `substrate/Appendix.md`.
