...
book.api.runtime.contracts.schema, rather than inferring from stderr strings.
"""
...
from book.api.runtime.contracts import models as runtime_models  # type: ignore
