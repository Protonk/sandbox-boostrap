...
Host: Sonoma 14.4.1 (23E224), CARTON snapshot (book/integration/carton/bundle/CARTON.json).
...
- **CARTON contract:** use `book/integration/carton/bundle/CARTON.json` plus the contract snapshots under `book/integration/carton/bundle/contracts/` to review frozen facts (probes, runtime blob path, op coverage) and any drift.
