...
Lightweight helpers used in the TextEdit chapter to turn entitlements, SBPL, and container notes into machine-readable artifacts under `book/evidence/profiles/textedit/output/`.
