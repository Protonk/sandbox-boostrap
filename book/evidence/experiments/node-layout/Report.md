...
- `book/evidence/experiments/node-layout/out/summary.json` containing per-variant blob and section lengths, stride statistics, tag counts, and decoder snapshots for this host.
...
- `book/evidence/experiments/node-layout/analyze.py` as the main ingestion and summary script.
- `book/evidence/experiments/node-layout/out/summary.json` with per-variant structural data and decoder output.
