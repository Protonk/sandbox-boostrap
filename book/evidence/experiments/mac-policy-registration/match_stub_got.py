...
DEFAULT_STUB_MAP = "book/evidence/dumps/ghidra/out/{build}/sandbox-kext-stub-got-map/stub_got_map.json"
DEFAULT_OTOOL = "book/evidence/experiments/mac-policy-registration/out/otool_indirect_symbols.txt"
DEFAULT_OUT = "book/evidence/experiments/mac-policy-registration/out/stub_targets.json"
