...
def main() -> int:
    ...
    parser.add_argument(
        "--string-calls",
        default="book/evidence/dumps/ghidra/out/14.4.1-23E224/kernel-collection-string-call-sites/string_call_sites.json",
        help="Path to string_call_sites.json",
    )
    parser.add_argument(
        "--fileset-index",
        default="book/evidence/experiments/mac-policy-registration/out/kc_fileset_index.json",
        help="Path to kc_fileset_index.json",
    )
    parser.add_argument(
        "--out",
        default="book/evidence/experiments/mac-policy-registration/out/mac_policy_register_call_sites.json",
        help="Output path",
    )
    parser.add_argument(
        "--string-filter",
