...
4) Revisit op-table candidates only after a concrete dispatcher/mac_policy_ops candidate exists; align against `book/integration/carton/bundle/relationships/mappings/op_table/op_table_map.json` before running table-materialization scans.
...
- Block disasm report: `book/evidence/dumps/ghidra/out/14.4.1-23E224/kernel-block-disasm-kc/disasm_report.json`.
- Tag-switch candidates (KC): `book/evidence/dumps/ghidra/out/14.4.1-23E224/kernel-tag-switch-kc/switch_candidates.json`.
- Function dumps (KC): `book/evidence/dumps/ghidra/out/14.4.1-23E224/kernel-function-dump-kc/function_dump.json`.
- Function info (top candidates): `book/evidence/dumps/ghidra/out/14.4.1-23E224/kernel-function-info-kc-top10/function_info.json`.
- String refs (KC): `book/evidence/dumps/ghidra/out/14.4.1-23E224/kernel-string-refs-kc/string_references.json`.
- ADRP scans (KC): `book/evidence/dumps/ghidra/out/14.4.1-23E224/kernel-adrp-add-kc-0xfffffe0007009f18/adrp_add_scan.json`, `book/evidence/dumps/ghidra/out/14.4.1-23E224/kernel-adrp-add-kc-0xfffffe000bf5b8b8/adrp_add_scan.json`, `book/evidence/dumps/ghidra/out/14.4.1-23E224/kernel-adrp-add-kc-0xfffffe0007005f98/adrp_add_scan.json`.
- Pointer entry for `FUN_fffffe00092fb9e0`: `book/evidence/dumps/ghidra/out/14.4.1-23E224/kernel-addr-lookup-kc/addr_lookup.json` (address `0xfffffe0007ca4040` in `__const`).
- Jump-table dump (KC): `book/evidence/dumps/ghidra/out/14.4.1-23E224/kernel-jump-table-dump-kc/jump_tables.json`.
- Pointer window (KC): `book/evidence/dumps/ghidra/out/14.4.1-23E224/kernel-pointer-window-kc/pointer_window.json`.
- Pointer window (KC, auto bounds): `book/evidence/dumps/ghidra/out/14.4.1-23E224/kernel-pointer-window-kc-auto/pointer_window.json`.

## Evidence & artifacts
- Project: `book/dumps/ghidra/projects/sandbox_14.4.1-23E224`.
- String refs: `book/evidence/dumps/ghidra/out/14.4.1-23E224/kernel-string-refs/string_references.json` (190 hits, no externals).
- Import census: `book/evidence/dumps/ghidra/out/14.4.1-23E224/kernel-imports/imports_all.json` plus filtered `imports_filtered_sandbox.json` (0 matches for applematch/mac_policy/sandbox/seatbelt).
- Data refs: `book/evidence/dumps/ghidra/out/14.4.1-23E224/kernel-data-define/data_refs.json` (sandbox strings + pointer targets, no callers).
- Pointer tables: `book/evidence/experiments/kernel-symbols/out/14.4.1-23E224/op_table_candidates.json` (dense tables, unreferenced so far).
