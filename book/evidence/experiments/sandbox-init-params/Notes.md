...
- Command (repo root): `INIT_PARAMS_PROBE_OUT=book/evidence/experiments/sandbox-init-params/out/init_params_probe.sb.bin sb/build/init_params_probe`.
...
- Runs summarized in `out/handle_runs_summary.json`:
  ...
  - `file_simple` (profile `book/evidence/experiments/sandbox-init-params/sb/simple_file_profile.sb`): `handle[0]=0`, `call_code=0`, `blob_len=416`, `sha256=19832e...3c92`, `apply_return=0`.
