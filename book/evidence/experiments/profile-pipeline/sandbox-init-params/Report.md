...
- Depends on the closed experiment at `book/evidence/experiments/field2-final-final/libsandbox-encoder/` for:
...
- Shared inputs: `book/evidence/experiments/field2-final-final/libsandbox-encoder/out/encoder_sites.json` (mutable buffer at builder+0xe98, `_sb_mutable_buffer_make_immutable` at 0x183ced36c returning sb_buffer*), `tag_layout_overrides.json` (tag layouts).
