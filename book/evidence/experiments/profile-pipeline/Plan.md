...
## Goals
- Keep the compile -> layout -> op-table -> vocab -> apply pipeline in one place with clear scope notes.
...
2) Add minimal probes only when they sharpen a specific question (single-change SBPL or single new handle variant).
