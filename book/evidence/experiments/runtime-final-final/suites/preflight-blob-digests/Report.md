...
- Validation IR: `book/evidence/syncretic/validation/out/experiments/preflight-blob-digests/blob_digests_ir.json` is the tool-consumed source for `.sb.bin` preflight.
...
- Digest corpus + tool wiring
  ...
  - `book/evidence/syncretic/validation/out/experiments/preflight-blob-digests/blob_digests_ir.json` — tool-consumed IR.
...
python3 book/evidence/experiments/runtime-final-final/suites/preflight-blob-digests/blob_apply_matrix.py \
  ...
  --blob book/evidence/syncretic/validation/fixtures/blobs/airlock.sb.bin \
  --blob book/evidence/syncretic/validation/fixtures/blobs/bsd.sb.bin \
  --blob book/evidence/syncretic/validation/fixtures/blobs/sample.sb.bin \
