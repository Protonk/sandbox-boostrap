...
5. Keep outputs and signature candidates in `book/evidence/experiments/runtime-final-final/suites/preflight-blob-digests/out/` until they are stable enough to consider promotion.
