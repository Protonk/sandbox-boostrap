...
This experiment is intentionally small and uses only plan/registry data + the shared runtime harness. It is a runtime companion to the structural anchor work in `book/evidence/experiments/field2-final-final/probe-op-structure/`.
