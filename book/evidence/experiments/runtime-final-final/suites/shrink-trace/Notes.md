...
- New run after migration: trace advanced to iteration 4 but failed with `sandbox-exec` SIGABRT on iteration 2 and later a profile parse error from an invalid network rule (`local ip "remote:*:2000"`). Outputs are in `book/evidence/experiments/runtime-final-final/suites/shrink-trace/out/`.
- Captured preflight scan output to `book/evidence/experiments/runtime-final-final/suites/shrink-trace/out/preflight_scan.json` and `log show` output to `book/evidence/experiments/runtime-final-final/suites/shrink-trace/out/log_show_sandbox_exec.txt`.
...
- Current run (`SEED_DYLD=1`) stalls on SIGABRT in iteration 2; stall bundle in `book/evidence/experiments/runtime-final-final/suites/shrink-trace/out/stall_iter_2/`.
- Manual abort capture saved to `book/evidence/experiments/runtime-final-final/suites/shrink-trace/out/stdout.txt`, `book/evidence/experiments/runtime-final-final/suites/shrink-trace/out/stderr.txt`, and `book/evidence/experiments/runtime-final-final/suites/shrink-trace/out/exitcode.txt` (exit code 134).
- Copied latest crash report to `book/evidence/experiments/runtime-final-final/suites/shrink-trace/out/sandbox_target-2025-12-24-181523.ips`.
