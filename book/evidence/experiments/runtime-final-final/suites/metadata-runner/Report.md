...
python -m book.api.runtime run \
  --plan book/evidence/experiments/runtime-final-final/suites/metadata-runner/plan.json \
  --channel launchd_clean \
  --out book/evidence/experiments/runtime-final-final/suites/metadata-runner/out
```
...
python -m book.api.runtime emit-promotion \
  --bundle book/evidence/experiments/runtime-final-final/suites/metadata-runner/out/LATEST \
  --out book/evidence/experiments/runtime-final-final/suites/metadata-runner/out/promotion_packet.json
```
...
## Evidence & artifacts
- Plan: `book/evidence/experiments/runtime-final-final/suites/metadata-runner/plan.json`.
- Registry: `book/evidence/experiments/runtime-final-final/suites/metadata-runner/registry/probes.json`, `book/evidence/experiments/runtime-final-final/suites/metadata-runner/registry/profiles.json`.
- Runtime bundle authority: `book/evidence/experiments/runtime-final-final/suites/metadata-runner/out/<run_id>/artifact_index.json`.
- Normalized events: `book/evidence/experiments/runtime-final-final/suites/metadata-runner/out/<run_id>/runtime_events.normalized.json`.
- Raw results: `book/evidence/experiments/runtime-final-final/suites/metadata-runner/out/<run_id>/runtime_results.json`.
- SBPL sources: `book/evidence/experiments/runtime-final-final/suites/metadata-runner/sb/metadata_*.sb`.
- Optional promotion packet: `book/evidence/experiments/runtime-final-final/suites/metadata-runner/out/promotion_packet.json`.
