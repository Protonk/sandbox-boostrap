...
2) Build and run the matrix:
   - `python3 book/evidence/experiments/runtime-final-final/suites/metadata-runner/run_metadata.py`
...
3) Quick single-probe repro:  
   ...
   - `swiftc book/api/runtime/native/metadata_runner/metadata_runner.swift book/api/runtime/native/ToolMarkers.swift /tmp/seatbelt_callout_shim.o -o /tmp/metadata_runner_test`  
...
- Structural anchor checks moved to `book/evidence/experiments/field2-final-final/metadata-runner/` (field2-focused).
