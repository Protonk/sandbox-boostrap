...
## Execution
- Run: `python -m book.api.runtime run --plan book/evidence/experiments/runtime-final-final/suites/anchor-filter-map/plan.json --channel launchd_clean --out book/evidence/experiments/runtime-final-final/suites/anchor-filter-map/out`
- Emit packet: `python -m book.api.runtime emit-promotion --bundle book/evidence/experiments/runtime-final-final/suites/anchor-filter-map/out/LATEST --out book/evidence/experiments/runtime-final-final/evidence/packets/anchor-filter-map.promotion_packet.json`
