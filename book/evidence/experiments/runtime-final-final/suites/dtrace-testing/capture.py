...
def main() -> int:
    ...
    raw_out = pathlib.Path(args.raw_out) if args.raw_out else pathlib.Path(
        f"book/evidence/experiments/runtime-final-final/suites/dtrace-testing/out/raw/{phase}.jsonl"
    )
    meta_out = pathlib.Path(args.meta_out) if args.meta_out else pathlib.Path(
        f"book/evidence/experiments/runtime-final-final/suites/dtrace-testing/out/meta/{phase}.json"
    )
    ...
    script_out = path_utils.ensure_absolute(
        f"book/evidence/experiments/runtime-final-final/suites/dtrace-testing/out/meta/dtrace_{phase}.d",
        repo_root,
    )
    stderr_out = path_utils.ensure_absolute(
        f"book/evidence/experiments/runtime-final-final/suites/dtrace-testing/out/meta/dtrace_{phase}.stderr",
        repo_root,
    )
