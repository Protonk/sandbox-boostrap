...
- DTrace capture helper: `book/evidence/experiments/runtime-final-final/suites/dtrace-testing/capture.py`.
- Normalization helper: `book/evidence/experiments/runtime-final-final/suites/dtrace-testing/normalize.py`.
- Raw JSONL traces per phase in `book/evidence/experiments/runtime-final-final/suites/dtrace-testing/out/raw/`.
- Phase-keyed deny signatures in `book/evidence/experiments/runtime-final-final/suites/dtrace-testing/out/normalized/deny_signatures.json`.
- Entitlements witness artifacts in `book/evidence/experiments/runtime-final-final/suites/dtrace-testing/out/entitlements/`.
...
- Entitlements (codesign warnings; no blob emitted):
  - `book/evidence/experiments/runtime-final-final/suites/dtrace-testing/out/entitlements/EntitlementJail.app.entitlements.txt`
  - `book/evidence/experiments/runtime-final-final/suites/dtrace-testing/out/entitlements/ProbeService_debuggable.xpc.entitlements.txt`
- Entitlements (brittle string witness):
  - `book/evidence/experiments/runtime-final-final/suites/dtrace-testing/out/entitlements/ProbeService_debuggable.entitlements.strings.txt`
- Entitlements (runtime witness):
  - `book/evidence/experiments/runtime-final-final/suites/dtrace-testing/out/entitlements/ProbeService_debuggable.capabilities_snapshot.json`
  - `book/evidence/experiments/runtime-final-final/suites/dtrace-testing/out/entitlements/ProbeService_debuggable.capabilities_snapshot_smoke.json`
  - `book/evidence/experiments/runtime-final-final/suites/dtrace-testing/out/entitlements/ProbeService_debuggable.capabilities_snapshot_idle.json`
  - `book/evidence/experiments/runtime-final-final/suites/dtrace-testing/out/entitlements/ProbeService_debuggable.capabilities_snapshot_interaction.json`
- DTrace capture artifacts:
  - `book/evidence/experiments/runtime-final-final/suites/dtrace-testing/out/meta/dtrace_smoke.stderr`
  - `book/evidence/experiments/runtime-final-final/suites/dtrace-testing/out/meta/dtrace_idle.stderr`
  - `book/evidence/experiments/runtime-final-final/suites/dtrace-testing/out/meta/dtrace_interaction.stderr`
  - `book/evidence/experiments/runtime-final-final/suites/dtrace-testing/out/meta/smoke.json`
  - `book/evidence/experiments/runtime-final-final/suites/dtrace-testing/out/meta/idle.json`
  - `book/evidence/experiments/runtime-final-final/suites/dtrace-testing/out/meta/interaction.json`
  - `book/evidence/experiments/runtime-final-final/suites/dtrace-testing/out/raw/smoke.jsonl` (empty)
  - `book/evidence/experiments/runtime-final-final/suites/dtrace-testing/out/raw/idle.jsonl` (empty)
  - `book/evidence/experiments/runtime-final-final/suites/dtrace-testing/out/raw/interaction.jsonl` (empty)
- Normalized summary:
  - `book/evidence/experiments/runtime-final-final/suites/dtrace-testing/out/normalized/deny_signatures.json`
- Interaction outputs:
  - `book/evidence/experiments/runtime-final-final/suites/dtrace-testing/out/interaction/fs_op_stat.json`
  - `book/evidence/experiments/runtime-final-final/suites/dtrace-testing/out/interaction/fs_op_open_read.json`
  - `book/evidence/experiments/runtime-final-final/suites/dtrace-testing/out/interaction/fs_op_listdir.json`
- Non-system target (for PID-attach control):
  - `book/evidence/experiments/runtime-final-final/suites/dtrace-testing/targets/sleep_loop.c`
  - `book/evidence/experiments/runtime-final-final/suites/dtrace-testing/targets/sleep_loop`
  - `book/evidence/experiments/runtime-final-final/suites/dtrace-testing/out/meta/dtrace_non_system.json`
  - `book/evidence/experiments/runtime-final-final/suites/dtrace-testing/out/meta/dtrace_non_system.stderr`
  - `book/evidence/experiments/runtime-final-final/suites/dtrace-testing/out/meta/dtrace_non_system.stdout`
  - `book/evidence/experiments/runtime-final-final/suites/dtrace-testing/out/meta/dtrace_non_system_sudo.json`
  - `book/evidence/experiments/runtime-final-final/suites/dtrace-testing/out/meta/dtrace_non_system_sudo.stderr`
  - `book/evidence/experiments/runtime-final-final/suites/dtrace-testing/out/meta/dtrace_non_system_sudo.stdout`
...
- The non-system sudo run used a `sleep_loop` PID captured from the process launch; the PID is ephemeral but matches the intended target in `book/evidence/experiments/runtime-final-final/suites/dtrace-testing/out/meta/dtrace_non_system_sudo.json`.
