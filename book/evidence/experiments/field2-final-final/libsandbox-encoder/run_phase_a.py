...
def main() -> None:
    for stem in ["matrix_v1", "matrix_v2"]:
        sb_path = ROOT / f"book/evidence/experiments/field2-final-final/libsandbox-encoder/sb/{stem}.sb"
        if not sb_path.exists():
            continue
        out_blob = ROOT / f"book/evidence/experiments/field2-final-final/libsandbox-encoder/out/{stem}.sb.bin"
        out_json = ROOT / f"book/evidence/experiments/field2-final-final/libsandbox-encoder/out/{stem}_field2_encoder_matrix.json"
