...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    ap.add_argument(
        "--join",
        type=Path,
        default=Path("book/evidence/experiments/field2-final-final/libsandbox-encoder/out/network_matrix/encoder_write_join.json"),
        help="Encoder write join summary",
    )
    ap.add_argument(
        "--events",
        type=Path,
        default=Path("book/evidence/experiments/field2-final-final/libsandbox-encoder/out/network_matrix/encoder_write_events.jsonl"),
        help="Encoder write event mapping",
    )
    ap.add_argument(
        "--index",
        type=Path,
        default=Path("book/evidence/experiments/field2-final-final/libsandbox-encoder/out/network_matrix/index.json"),
        help="Network matrix index JSON (for section offsets)",
    )
    ap.add_argument(
        "--out",
        type=Path,
        default=Path("book/evidence/experiments/field2-final-final/libsandbox-encoder/out/network_matrix/encoder_write_record_map.json"),
