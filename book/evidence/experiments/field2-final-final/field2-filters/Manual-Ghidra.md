...
- Relevant task outputs:
  - `book/evidence/dumps/ghidra/out/14.4.1-23E224/kernel-tag-switch/switch_candidates.json` (computed-jump ranking). Top candidates include `FUN_ffffff80005bbb90`, `FUN_ffffff8002377c16`, `FUN_ffffff8000546e60`, `FUN_ffffff80006e9310`, `FUN_ffffff80007f9150`, `FUN_ffffff8002222324`, `FUN_ffffff80008641c0`, `FUN_ffffff80016a17ac`, `FUN_ffffff8000902bb0`, `FUN_ffffff80017b7748`.
  - `book/evidence/dumps/ghidra/out/14.4.1-23E224/kernel-op-table/op_table_candidates.json` (op-table scan, mostly dense; may help find entrypoints).
  - `book/evidence/dumps/ghidra/out/14.4.1-23E224/kernel-field2-mask-scan/mask_scan.json` and `kernel-imm-search` dirs (all empty for target masks/immediates).
...
- Drop function dumps and notes in `book/evidence/dumps/ghidra/out/14.4.1-23E224/kernel-function-dump/` (via `kernel-function-dump.py`) or export text nearby.
