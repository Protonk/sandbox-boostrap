...
Produced by `book/evidence/experiments/probe-op-structure/analyze_profiles.py`, `anchor_scan.py`, and related helpers. Anchors probe SBPL variants plus a few system profiles to inspect node field usage, literals, and `field2` values.
...
- `python3 book/evidence/experiments/probe-op-structure/analyze_profiles.py`
- `python3 book/evidence/experiments/probe-op-structure/anchor_scan.py`
