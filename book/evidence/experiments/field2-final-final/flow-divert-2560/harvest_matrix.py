...
def main() -> None:
    sb_dir = Path("book/evidence/experiments/field2-final-final/flow-divert-2560/sb/build")
    ...
    out_dir = Path("book/evidence/experiments/field2-final-final/flow-divert-2560/out")
