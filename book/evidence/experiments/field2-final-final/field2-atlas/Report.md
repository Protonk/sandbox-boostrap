...
- Inputs: `book/graph/mappings/vocab/{ops.json,filters.json}`, `book/evidence/graph/mappings/tag_layouts/tag_layouts.json`, `book/evidence/graph/mappings/anchors/anchor_filter_map.json`, `book/graph/mappings/system_profiles/{digests.json,static_checks.json}`, `book/evidence/experiments/field2-final-final/field2-filters/out/field2_inventory.json`, runtime signatures under `book/graph/mappings/runtime/` (notably `runtime_signatures.json`). Runtime events/baseline/manifest are resolved from the promotion packet export surface.
