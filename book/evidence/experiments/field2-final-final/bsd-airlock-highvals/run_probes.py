...
from book.api.profile import compile_sbpl_file, decoder  # type: ignore
...
def main() -> None:
    ...
    sb_dir = repo_root / "book/evidence/experiments/field2-final-final/bsd-airlock-highvals/sb"
