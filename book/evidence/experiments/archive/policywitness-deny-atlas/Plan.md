  ...
  "records": [
    {
      ...
      "limits": [],
      "probe_log_path": "book/evidence/experiments/policywitness-deny-atlas/out/<run_id>/...",
      "observer_report_path": "book/evidence/experiments/policywitness-deny-atlas/out/<run_id>/..."
    }
  ]
}
```
