...
Kernel-side evidence is sourced from Ghidra analysis outputs under `book/evidence/dumps/ghidra/out/14.4.1-23E224/find-field2-evaluator/`, driven by scripts under `book/api/ghidra/scripts/`.
...
The kernel-side work in `book/evidence/dumps/ghidra/out/14.4.1-23E224/find-field2-evaluator/` supports two negative conclusions.
