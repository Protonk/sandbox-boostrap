...
- Attach-first harness (API): book/api/entitlementjail/frida.py (wrapper in book/evidence/experiments/frida-testing/run_ej_frida.py).
- Hook scripts (API): book/api/frida/hooks/ (smoke, fs_open_selftest, sandbox_check_minimal, sandbox_check_trace, execmem_trace).
- Experiment-only hooks: book/evidence/experiments/frida-testing/hooks/ (fs_open, sandbox_trace, sandbox_export_isolation, etc.).
- Hook script for per-export isolation: book/evidence/experiments/frida-testing/hooks/sandbox_export_isolation.js.
- Hook script for extension selftest calls: book/evidence/experiments/frida-testing/hooks/sandbox_extension_selftest.js.
- Output layout with manifest and observer logs under book/evidence/experiments/frida-testing/out/<run_id>/.
...
- Completed: removed legacy run artifacts from book/evidence/experiments/frida-testing/out/.
...
## Evidence & artifacts
- Harness (API): book/api/entitlementjail/frida.py (wrapper: book/evidence/experiments/frida-testing/run_ej_frida.py).
...
- Hooks (experiment-only): book/evidence/experiments/frida-testing/hooks/fs_open.js, book/evidence/experiments/frida-testing/hooks/fs_open_funnel.js, book/evidence/experiments/frida-testing/hooks/fs_op_funnel.js, book/evidence/experiments/frida-testing/hooks/discover_sandbox_exports.js, book/evidence/experiments/frida-testing/hooks/sandbox_trace.js, book/evidence/experiments/frida-testing/hooks/sandbox_export_isolation.js, book/evidence/experiments/frida-testing/hooks/sandbox_extension_selftest.js.
- Config inputs: book/evidence/experiments/frida-testing/out/inputs/sandbox_export_isolation/sandbox_check.json, book/evidence/experiments/frida-testing/out/inputs/sandbox_export_isolation/sandbox_check_bulk.json, book/evidence/experiments/frida-testing/out/inputs/sandbox_export_isolation/sandbox_extension_issue_file.json, book/evidence/experiments/frida-testing/out/inputs/sandbox_export_isolation/sandbox_extension_issue_mach.json, book/evidence/experiments/frida-testing/out/inputs/sandbox_export_isolation/sandbox_extension_consume.json, book/evidence/experiments/frida-testing/out/inputs/sandbox_export_isolation/sandbox_extension_release.json, book/evidence/experiments/frida-testing/out/inputs/sandbox_export_isolation/sandbox_extension_selftest.json.
...
- Successful runs:
  - book/evidence/experiments/frida-testing/out/d8e2c72a-493d-4518-9dfa-b18b57a41e83/manifest.json (probe_catalog + smoke).
  - book/evidence/experiments/frida-testing/out/41d1a763-bfc3-4dbf-9920-0335d001383b/manifest.json (fs_op + smoke).
  - book/evidence/experiments/frida-testing/out/54bf34f2-a672-4eb2-8598-08861103d2f3/manifest.json (fs_op + fs_open.js).
  - book/evidence/experiments/frida-testing/out/9e49bf0d-da44-4b2a-a928-af6a7ba6f274/manifest.json (fs_op + fs_open.js + downloads path-class; no fs-open events).
  - book/evidence/experiments/frida-testing/out/c1fe32d2-b058-43ff-81ca-836e346af8fa/manifest.json (fs_op + fs_open.js + explicit tmp_dir path; fs-open events captured).
  - book/evidence/experiments/frida-testing/out/88533003-dc07-4b5a-96fa-30a157789c21/manifest.json (fs_op + fs_open_funnel.js + downloads path-class; no funnel-hit events).
  - book/evidence/experiments/frida-testing/out/dd0955c2-864a-4471-96b8-4b97e609f8b3/manifest.json (fs_op + fs_open_funnel.js + downloads path-class; mkdirat errno 1).
  - book/evidence/experiments/frida-testing/out/da23cd52-d323-41ae-bac7-a50f8aefe3cd/manifest.json (fs_op + fs_op_funnel.js + downloads path-class; mkdir/mkdirat errno evidence).
  - book/evidence/experiments/frida-testing/out/eca03911-40f3-4df0-a74d-9aba5f0c0c1e/manifest.json (probe_catalog + discover_sandbox_exports.js).
  - book/evidence/experiments/frida-testing/out/25d6ade2-0b08-40d2-b37c-fbcad882e11a/manifest.json (probe_catalog + sandbox_trace.js; trace unavailable).
  - book/evidence/experiments/frida-testing/out/b218b156-0b63-4265-8dc5-7aec41de3981/manifest.json (probe_catalog + fs_open_selftest).
  - book/evidence/experiments/frida-testing/out/b03ad4a9-d2b3-438e-a71c-cab0ec92b0f3/manifest.json (probe_catalog + fs_open_selftest under minimal@injectable).
  - book/evidence/experiments/frida-testing/out/916d33bd-97fb-4cd1-9346-fe0c70faa542/manifest.json (probe_catalog + smoke under minimal@injectable).
  - book/evidence/experiments/frida-testing/out/c474eb4e-57b9-4325-8e62-a140b4b14635/manifest.json (probe_catalog + smoke under minimal@injectable; elevated).
  - book/evidence/experiments/frida-testing/out/49e69f56-c29b-492e-acf7-7c3e12827de8/manifest.json (probe_catalog + smoke under net_client@injectable; elevated).
  - book/evidence/experiments/frida-testing/out/e3d62720-ce97-48b8-a243-62b1a067635e/manifest.json (probe_catalog + smoke under downloads_rw@injectable; elevated).
  - book/evidence/experiments/frida-testing/out/9917a124-ce0e-4809-9d83-87bb8a10d731/manifest.json (probe_catalog + smoke under user_selected_executable@injectable; elevated).
  - book/evidence/experiments/frida-testing/out/30c14e26-0f69-4d67-87e8-ca30cd01151a/manifest.json (probe_catalog + smoke under bookmarks_app_scope@injectable; elevated).
  - book/evidence/experiments/frida-testing/out/2d0dc547-22af-4305-9ba8-fecf2bc48cc1/manifest.json (probe_catalog + smoke under temporary_exception@injectable; elevated).
  - book/evidence/experiments/frida-testing/out/1459e42d-3293-4521-9f27-5e4305ac6cf0/manifest.json (probe_catalog + smoke under fully_injectable after update).
  - book/evidence/experiments/frida-testing/out/1d996a72-4c75-4f43-bb71-639f445fd31d/manifest.json (fs_op + fs_open_selftest under minimal@injectable; elevated).
  - book/evidence/experiments/frida-testing/out/265ebd80-5536-444d-aaf3-dea3cdf7bb16/manifest.json (sandbox_check + sandbox_check_trace under minimal@injectable; elevated).
  - book/evidence/experiments/frida-testing/out/ecb71fb6-3213-4285-978d-33583472ccbd/manifest.json (sandbox_check + sandbox_check_minimal under minimal@injectable; elevated).
  - book/evidence/experiments/frida-testing/out/d36438ca-f9d1-4d8d-9840-0f31c090ffd6/manifest.json (fs_op + fs_open_funnel.js denied path).
  - book/evidence/experiments/frida-testing/out/cb747a39-41a8-4e1b-874d-ef732c15eb0a/manifest.json (probe_catalog + execmem_trace.js).
  - book/evidence/experiments/frida-testing/out/5a6cbff3-8dcb-4a5c-b125-c7298bcfeab2/manifest.json (jit_map_jit + execmem_trace.js).
  - book/evidence/experiments/frida-testing/out/21f80aa0-315d-4b55-9f74-de0098be48f8/manifest.json (fs_op + fs_open_funnel.js readlink).
  - book/evidence/experiments/frida-testing/out/1f3eadb2-ee07-40c3-aefd-d22f027392de/manifest.json (jit_rwx_legacy + execmem_trace.js).
  - book/evidence/experiments/frida-testing/out/5475128c-90e3-4b02-bf8a-2b27b202c873/manifest.json (fs_op + fs_open_funnel.js readlink EACCES).
  - book/evidence/experiments/frida-testing/out/a4aa9464-c65d-4f81-847f-c7b4f001d3ef/manifest.json (fs_op + sandbox_check_minimal.js post-trigger attach).
  - book/evidence/experiments/frida-testing/out/31a9fdb4-2192-4988-8dc5-3a23aef6e181/manifest.json (fs_op_wait + sandbox_check_minimal.js gated FIFO).
  - book/evidence/experiments/frida-testing/out/0c400964-8763-4fcf-ae93-8ffc25866b70/manifest.json (sandbox_export_isolation + sandbox_check; hook installed, no calls).
  - book/evidence/experiments/frida-testing/out/71cbf237-598d-40cf-aeac-60d7f538fde2/manifest.json (sandbox_export_isolation + sandbox_check_bulk; hook installed, no calls).
  - book/evidence/experiments/frida-testing/out/2960d7bd-3555-402d-b301-93001d0988d5/manifest.json (sandbox_check + sandbox_export_isolation; sandbox_check call observed).
  - book/evidence/experiments/frida-testing/out/359239c3-a0d2-4750-9ed8-dad37b29eabc/manifest.json (sandbox_export_isolation + sandbox_extension_issue_file; hook installed, no calls).
  - book/evidence/experiments/frida-testing/out/7feb2f90-026e-41b6-a89a-0950680b6103/manifest.json (sandbox_export_isolation + sandbox_extension_issue_mach; hook installed, no calls).
  - book/evidence/experiments/frida-testing/out/f20641ce-63e7-40b6-9d38-3659fcb1246a/manifest.json (sandbox_export_isolation + sandbox_extension_consume; hook installed, no calls).
  - book/evidence/experiments/frida-testing/out/99e1a08e-f60e-49cf-a2b3-61b9d4d89b3a/manifest.json (sandbox_export_isolation + sandbox_extension_release; hook installed, no calls).
  - book/evidence/experiments/frida-testing/out/3866d936-2c9b-4322-a361-60821ab25ae9/manifest.json (sandbox_extension_selftest; issue attempt failed errno 1).
  - book/evidence/experiments/frida-testing/out/d5968de8-abeb-459f-9cc1-10bb4e997522/manifest.json (fs_op + smoke under fully_injectable_extensions; harness file created under run_dir).
  - book/evidence/experiments/frida-testing/out/0bc59fb9-6ef6-448b-8fb2-29a403913b3e/manifest.json (sandbox_extension issue_file /etc/hosts; token issued; hook captured call).
- Probe-error runs (run-xpc ok, probe returned error):
  - book/evidence/experiments/frida-testing/out/976bbb19-00f8-4590-b48f-062dae251f11/manifest.json (sandbox_extension issue_file harness path; errno 2).
  - book/evidence/experiments/frida-testing/out/a26f236f-166c-4321-817c-a995f951a426/manifest.json (fs_op target base; errno 21).
  - book/evidence/experiments/frida-testing/out/8a907c5b-79af-4e6e-9381-b1485c6dd6bf/manifest.json (fs_op target harness_dir; errno 21).
  - book/evidence/experiments/frida-testing/out/15d6f3ec-da32-4fe9-a765-407c3990ac82/manifest.json (sandbox_extension consume; errno 17; hook captured call).
  - book/evidence/experiments/frida-testing/out/335f82f3-3a70-4070-818d-22a7d3bfe3cd/manifest.json (sandbox_extension release; errno 22; hook captured call).
- Partial runs (Frida attach denied):
  - book/evidence/experiments/frida-testing/out/6baf62bd-00c2-4bca-9d9c-aa6cd4807187/manifest.json (fs_op + fs_open_selftest under plugin_host_relaxed).
  - book/evidence/experiments/frida-testing/out/c15262bf-19b2-47c3-bc38-76234fd4bc3e/manifest.json (probe_catalog + smoke under dyld_env_enabled).
  - book/evidence/experiments/frida-testing/out/56efece2-00ed-4814-89a6-94de7649056a/manifest.json (probe_catalog + smoke under jit_map_jit).
  - book/evidence/experiments/frida-testing/out/cb3bde87-6cb3-47cc-99ab-fc25621445a1/manifest.json (probe_catalog + smoke under jit_rwx_legacy).
  - book/evidence/experiments/frida-testing/out/9a1301d7-c4c5-483b-a107-d27505905225/manifest.json (probe_catalog + smoke under get-task-allow; xpc_error).
  - book/evidence/experiments/frida-testing/out/9b94fb08-cf29-482f-ab86-dac6995b8801/manifest.json (sandbox_extension consume short token; errno 22).
  - book/evidence/experiments/frida-testing/out/3636ac13-d8f1-43c8-a2fb-e15ea5f7dab5/manifest.json (sandbox_extension consume full token; errno 17).
  - book/evidence/experiments/frida-testing/out/1d2adecd-8894-488a-96b7-5eedd27593ca/manifest.json (sandbox_extension release full token; errno 22).
- Timed-out runs (manifest missing):
  - book/evidence/experiments/frida-testing/out/59e0530c-0817-49ad-ad0c-d824c7186b2c/ej/capabilities_snapshot.json (debuggable; Frida attach failed; run_xpc missing).
  - book/evidence/experiments/frida-testing/out/c134a17d-2147-4031-9874-610a2e9de20b/ej/capabilities_snapshot.json (debuggable; Frida attach failed; run_xpc missing).
  - book/evidence/experiments/frida-testing/out/7cf0b52b-e6a8-4b27-9503-180d4dc9ccd3/ej/capabilities_snapshot.json (minimal@injectable probe_catalog; harness timeout; run_xpc missing).
- Blocked runs (XPC connection error in harness sandbox):
  - book/evidence/experiments/frida-testing/out/e1ee3f59-b895-49ab-ba4b-62d0bd27999b/manifest.json.
  - book/evidence/experiments/frida-testing/out/6ba32d45-72c2-48fe-9dbe-ffc5ba8753f9/manifest.json.
  - book/evidence/experiments/frida-testing/out/3317ec42-abe3-4ecb-a233-7e9ed5d3ca53/manifest.json.
  - book/evidence/experiments/frida-testing/out/994d18ad-9656-4c07-952a-3cdeb5b8a2af/manifest.json (minimal@injectable sweep).
  - book/evidence/experiments/frida-testing/out/d30a92eb-4a42-49de-875d-747691edc42a/manifest.json (net_client@injectable sweep).
  - book/evidence/experiments/frida-testing/out/e3c2b193-59c8-4cd1-82cd-9475aff52238/manifest.json (downloads_rw@injectable sweep).
  - book/evidence/experiments/frida-testing/out/ad8a7d53-5e05-429e-995f-346a6068ef44/manifest.json (user_selected_executable@injectable sweep).
  - book/evidence/experiments/frida-testing/out/f32fa4ed-9eef-48f0-a76e-cad99c5d27fc/manifest.json (bookmarks_app_scope@injectable sweep).
  - book/evidence/experiments/frida-testing/out/bcf5e8b2-8c05-4932-93e0-61fdeb5ec42e/manifest.json (temporary_exception@injectable sweep).
  - book/evidence/experiments/frida-testing/out/a066da1c-a9c5-4879-b8b5-ee91f745bee8/manifest.json (sandbox_extension issue_file under temporary_exception@injectable).
  - book/evidence/experiments/frida-testing/out/fdd4679d-599f-498e-b474-e32fc243c09c/manifest.json (sandbox_check_trace + probe_catalog).
  - book/evidence/experiments/frida-testing/out/4f40aa49-92c8-41b9-9b20-4dd8d0634e68/manifest.json (sandbox_check_trace + fs_op).
  - book/evidence/experiments/frida-testing/out/e25b0c21-6ef6-45da-a85e-03e3cd365ff5/manifest.json (sandbox_check_minimal + probe_catalog).
  - book/evidence/experiments/frida-testing/out/61944b88-78c8-480d-8176-320210f47308/manifest.json (sandbox_export_isolation + sandbox_check; XPC connection invalidated).
  - book/evidence/experiments/frida-testing/out/068168b1-205a-4b94-8a82-aeb3cac0888e/manifest.json (sandbox_export_isolation + sandbox_check_bulk; XPC connection invalidated).
- Output layout (fresh runs only):
  - book/evidence/experiments/frida-testing/out/<run_id>/manifest.json
  - book/evidence/experiments/frida-testing/out/<run_id>/ej/run_xpc.json
  - book/evidence/experiments/frida-testing/out/<run_id>/ej/logs/run_xpc.log
  - book/evidence/experiments/frida-testing/out/<run_id>/ej/logs/observer/<...>
  - book/evidence/experiments/frida-testing/out/<run_id>/frida/meta.json
  - book/evidence/experiments/frida-testing/out/<run_id>/frida/events.jsonl

## Run recipe (attach-first)
Example (attach via the @injectable digital twin):

```sh
./.venv/bin/python book/evidence/experiments/frida-testing/run_ej_frida.py \
...
./.venv/bin/python book/evidence/experiments/frida-testing/run_ej_frida.py \
  ...
  --script book/evidence/experiments/frida-testing/hooks/sandbox_export_isolation.js \
  --frida-config-path book/evidence/experiments/frida-testing/out/inputs/sandbox_export_isolation/sandbox_check.json
```
...
Legacy run artifacts were removed from book/evidence/experiments/frida-testing/out/. No current host witness remains; treat any inference as hypothesis until new runs are captured.
