...
- Status remains `partial` by design; do not treat it as flaky. The same `/tmp` → `/private/tmp` behavior is documented in `book/evidence/experiments/vfs-canonicalization/Report.md`.
