...
- Out of scope: new probe design lives in the originating experiments (primarily `book/evidence/experiments/runtime-adversarial`).
...
- Evidence tier: mapped (not bedrock; bedrock surfaces are listed in `book/evidence/graph/concepts/BEDROCK_SURFACES.json`).
