...
## Evidence & artifacts
- Plan: `book/evidence/experiments/runtime-frontiers/plan.json`
- Registry: `book/evidence/experiments/runtime-frontiers/registry/{probes,profiles}.json`
- Profiles: `book/evidence/experiments/runtime-frontiers/sb/*.sb`
...
python -m book.api.runtime run \
  ...
  --out book/evidence/experiments/runtime-frontiers/out
```
