...
def main() -> None:
    ...
    out_root = path_utils.ensure_absolute(Path("book/experiments/deny-delay-detail/out"), repo_root)
    ...
    sbpl_profile = Path("book/experiments/sbpl-graph-runtime/profiles/allow_all.sb")
    sbpl = SbplAction(
        command=CommandSpec(
