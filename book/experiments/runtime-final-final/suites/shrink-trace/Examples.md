...
Key artifacts:
- `book/experiments/runtime-final-final/suites/shrink-trace/out/trace_baseline/profiles/trace.sb`
- `book/experiments/runtime-final-final/suites/shrink-trace/out/trace_baseline/profiles/shrunk.sb`
- `book/experiments/runtime-final-final/suites/shrink-trace/out/trace_baseline/phases/trace/metrics.jsonl`
...
Key artifacts:
- `book/experiments/runtime-final-final/suites/shrink-trace/out/shrink_net_required/profiles/trace.sb`
- `book/experiments/runtime-final-final/suites/shrink-trace/out/shrink_net_required/profiles/shrunk.sb`
- `book/experiments/runtime-final-final/suites/shrink-trace/out/shrink_net_required/phases/shrink/stdout.txt`
...
Key artifacts:
- `book/experiments/runtime-final-final/suites/shrink-trace/out/shrink_spawn/profiles/shrunk.sb`
- `book/experiments/runtime-final-final/suites/shrink-trace/out/shrink_spawn/phases/trace/metrics.jsonl`

## Example D: Loader boundary (sandbox_min, seed off)

Run directory:
- `book/experiments/runtime-final-final/suites/shrink-trace/out/trace_min`
...
Key artifacts:
- `book/experiments/runtime-final-final/suites/shrink-trace/out/trace_min/phases/trace/status.json`
- `book/experiments/runtime-final-final/suites/shrink-trace/out/trace_min/profiles/shrunk.sb`

## Example E: Dyld import sensitivity (matrix contrast)

Run directories:
- `book/experiments/runtime-final-final/suites/shrink-trace/out/matrix/sandbox_target_dyld1_netparsed_streak2`
- `book/experiments/runtime-final-final/suites/shrink-trace/out/matrix/sandbox_target_dyld0_netparsed_streak2`
...
Key artifacts:
- `book/experiments/runtime-final-final/suites/shrink-trace/out/matrix/summary.json` (matrix summary)
- `book/experiments/runtime-final-final/suites/shrink-trace/out/matrix/sandbox_target_dyld1_netparsed_streak2/profiles/trace.sb`
- `book/experiments/runtime-final-final/suites/shrink-trace/out/matrix/sandbox_target_dyld0_netparsed_streak2/profiles/trace.sb`

## Example F: Unused rule removal (manual shrink)

Run directory:
- `book/experiments/runtime-final-final/suites/shrink-trace/out/shrink_unused`
...
Key artifacts:
- `book/experiments/runtime-final-final/suites/shrink-trace/out/shrink_unused/profiles/trace.sb`
- `book/experiments/runtime-final-final/suites/shrink-trace/out/shrink_unused/phases/shrink/stdout_manual.txt`

## Example G: Network rule mode failure (required connect)

Run directories:
- `book/experiments/runtime-final-final/suites/shrink-trace/out/matrix/sandbox_net_required_dyld1_netparsed_streak2`
- `book/experiments/runtime-final-final/suites/shrink-trace/out/matrix/sandbox_net_required_dyld1_netdrop_streak2`
...
Key artifacts:
- `book/experiments/runtime-final-final/suites/shrink-trace/out/matrix/summary.json` (matrix summary)
- `book/experiments/runtime-final-final/suites/shrink-trace/out/matrix/sandbox_net_required_dyld1_netparsed_streak2/profiles/shrunk.sb`
- `book/experiments/runtime-final-final/suites/shrink-trace/out/matrix/sandbox_net_required_dyld1_netdrop_streak2/phases/trace/status.json`
...
- **Network rules dropped for a required workload**: the required-connect fixture fails to converge when `NETWORK_RULES=drop` even though the operation is required. In the matrix this shows up as `trace_status=no_new_rules` for `sandbox_net_required_dyld1_netdrop_streak2` and `sandbox_net_required_dyld1_netdrop_streak3` in `book/experiments/runtime-final-final/suites/shrink-trace/out/matrix/summary.json`. This is a tool choice, not a sandbox constraint, and it produces a false "clean stop."
- **Stop-condition sensitivity**: the same fixture and host can converge under one streak but stop early under another (for example, `sandbox_target_dyld1_netparsed_streak2` succeeded while `sandbox_target_dyld1_netparsed_streak3` ended `no_new_rules` in `book/experiments/runtime-final-final/suites/shrink-trace/out/matrix/summary.json`). This suggests sensitivity to log timing or deny capture, not a stable sandbox requirement.
- **High rejected-rule counts**: runs with large `bad_rules` counts (for example, `sandbox_net_required_dyld1_netparsed_streak3` reports `bad_rules=419` in `book/experiments/runtime-final-final/suites/shrink-trace/out/matrix/summary.json`) indicate parser noise or deny formats that the rule generator cannot safely encode. This is a tooling limitation, not an inherent sandbox requirement.

### Signals of sandbox characteristics (partial)

- **Dyld import reduces the deny surface**: with `IMPORT_DYLD_SUPPORT=1`, trace profiles are smaller than their `IMPORT_DYLD_SUPPORT=0` counterparts (for example, `trace_lines=37` vs `49` for `sandbox_target` in `book/experiments/runtime-final-final/suites/shrink-trace/out/matrix/summary.json`). This indicates real loader dependencies on this host rather than fixture behavior.
- **Loader boundary aborts that still converge**: `sandbox_min` with `SEED_DYLD=0` reports early `rc=134` aborts in `book/experiments/runtime-final-final/suites/shrink-trace/out/trace_min/phases/trace/metrics.jsonl`, then converges after rules are added. This points to a genuine loader boundary (a host characteristic), not just a tracing artifact.
- **Create vs truncate remains required after shrink**: the shrunk baseline profile keeps both `file-write-create` and `file-write-data` for `out/hello.txt` (see `book/experiments/runtime-final-final/suites/shrink-trace/out/shrink_twostate/profiles/shrunk.sb`). This reflects the sandbox's distinct write operations on this host, not a tooling quirk.
- **Required operations persist through shrink**: the required network rule remains in `book/experiments/runtime-final-final/suites/shrink-trace/out/shrink_net_required/profiles/shrunk.sb`, and child-process rules remain in `book/experiments/runtime-final-final/suites/shrink-trace/out/shrink_spawn/profiles/shrunk.sb`. These are necessary to preserve program semantics on this host.

### Ambiguous cases (need more evidence)

- **`no_new_rules` can mean two things**: it might indicate a fully-allowed program, or it might indicate missing deny capture. The mixed outcomes in `book/experiments/runtime-final-final/suites/shrink-trace/out/matrix/summary.json` (success vs `no_new_rules` under similar knobs) suggest log-capture variability that is not yet fully bounded.
