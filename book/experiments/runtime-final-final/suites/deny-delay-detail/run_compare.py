...
def main() -> None:
    ...
    out_root = path_utils.ensure_absolute(Path("book/experiments/runtime-final-final/suites/deny-delay-detail/out"), repo_root)
    ...
    sbpl_profile = Path("book/experiments/runtime-final-final/suites/sbpl-graph-runtime/profiles/allow_all.sb")
    sbpl = SbplAction(
        command=CommandSpec(
