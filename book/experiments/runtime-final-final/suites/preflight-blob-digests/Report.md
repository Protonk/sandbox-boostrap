...
- Evidence sources:
  - Minimized witness corpus: `book/graph/concepts/validation/out/experiments/gate-witnesses/witness_results.json`
  - Direct blob-apply measurements for canonical `sys:*` fixtures: `out/blob_apply_matrix.outside_harness.json`
- Non-goals:
  - explaining *why* apply gating happens (see `book/experiments/runtime-final-final/suites/gate-witnesses/Report.md` and `troubles/EPERMx2.md`)
...
- Validation IR: `book/graph/concepts/validation/out/experiments/preflight-blob-digests/blob_digests_ir.json` is the tool-consumed source for `.sb.bin` preflight.
...
- Digest corpus + tool wiring
  ...
  - `book/graph/concepts/validation/out/experiments/preflight-blob-digests/blob_digests_ir.json` — tool-consumed IR.
...
python3 book/experiments/runtime-final-final/suites/preflight-blob-digests/inventory_repo_blobs.py \
  --out book/experiments/runtime-final-final/suites/preflight-blob-digests/out/repo_sb_bin_inventory.json
python3 book/experiments/runtime-final-final/suites/preflight-blob-digests/join_with_sys_digests.py \
  --out book/experiments/runtime-final-final/suites/preflight-blob-digests/out/sys_digest_join.json

# 2) compile determinism/parity (static-ish; no apply)
python3 book/experiments/runtime-final-final/suites/preflight-blob-digests/compile_determinism.py \
  --sbpl book/experiments/op-table-operation/sb/v0_empty.sb \
  --sbpl book/experiments/runtime-final-final/suites/gate-witnesses/out/witnesses/mach_bootstrap_deny_message_send/minimal_failing.sb \
  --runs 5 \
  --out book/experiments/runtime-final-final/suites/preflight-blob-digests/out/compile_determinism.json

# 3) blob apply matrix (requires an execution context where the control blob is not apply-gated)
python3 book/experiments/runtime-final-final/suites/preflight-blob-digests/blob_apply_matrix.py \
  --label outside_harness \
  --blob book/graph/concepts/validation/fixtures/blobs/airlock.sb.bin \
  --blob book/graph/concepts/validation/fixtures/blobs/bsd.sb.bin \
  --blob book/graph/concepts/validation/fixtures/blobs/sample.sb.bin \
  --out book/experiments/runtime-final-final/suites/preflight-blob-digests/out/blob_apply_matrix.outside_harness.json
...
python3 book/experiments/runtime-final-final/suites/preflight-blob-digests/blob_apply_matrix.py \
  ...
  --blob book/graph/concepts/validation/fixtures/blobs/bsd.sb.bin \
  --blob book/graph/concepts/validation/fixtures/blobs/sample.sb.bin \
  --out book/experiments/runtime-final-final/suites/preflight-blob-digests/out/blob_apply_matrix.in_harness.json

# 5) comparisons + controls
python3 book/experiments/runtime-final-final/suites/preflight-blob-digests/compare_apply_matrices.py \
  --matrix book/experiments/runtime-final-final/suites/preflight-blob-digests/out/blob_apply_matrix.in_harness.json \
  --matrix book/experiments/runtime-final-final/suites/preflight-blob-digests/out/blob_apply_matrix.outside_harness.json \
  --out book/experiments/runtime-final-final/suites/preflight-blob-digests/out/apply_matrix_comparison.json
python3 book/experiments/runtime-final-final/suites/preflight-blob-digests/collect_control_digests.py \
  --apply-matrix book/experiments/runtime-final-final/suites/preflight-blob-digests/out/blob_apply_matrix.in_harness.json \
  --apply-matrix book/experiments/runtime-final-final/suites/preflight-blob-digests/out/blob_apply_matrix.outside_harness.json \
  --out book/experiments/runtime-final-final/suites/preflight-blob-digests/out/control_digests.json

# 6) regenerate digest corpus (witnesses + outside-harness apply matrix)
python3 book/experiments/runtime-final-final/suites/preflight-blob-digests/collect_gate_blob_digests.py \
  --apply-matrix book/experiments/runtime-final-final/suites/preflight-blob-digests/out/blob_apply_matrix.outside_harness.json \
  --out book/experiments/runtime-final-final/suites/preflight-blob-digests/out/apply_gate_blob_digests.json
...
Planning notes and next validation targets live in `Plan.md`, and all structural-signal artifacts stay under `book/experiments/runtime-final-final/suites/preflight-blob-digests/out/` until/unless we decide to promote any of them.
