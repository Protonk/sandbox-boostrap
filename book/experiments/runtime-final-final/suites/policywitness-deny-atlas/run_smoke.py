...
def main() -> None:
    ...
    parser.add_argument("--out-root", default="book/experiments/runtime-final-final/suites/policywitness-deny-atlas/out")
    ...
    filters_map = _load_vocab(repo_root / "book/graph/mappings/vocab/filters.json", "filters")
