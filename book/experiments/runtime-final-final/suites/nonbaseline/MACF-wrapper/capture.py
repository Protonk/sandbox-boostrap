...
DEFAULT_HOOKS_FILE = "book/experiments/runtime-final-final/suites/nonbaseline/MACF-wrapper/out/meta/selected_hooks.json"
...
def main() -> int:
    ...
    raw_out_rel = args.raw_out or f"book/experiments/runtime-final-final/suites/nonbaseline/MACF-wrapper/out/raw/{args.run_id}.log"
    json_out_rel = args.json_out or f"book/experiments/runtime-final-final/suites/nonbaseline/MACF-wrapper/out/json/{args.run_id}.json"
    meta_out_rel = args.meta_out or f"book/experiments/runtime-final-final/suites/nonbaseline/MACF-wrapper/out/meta/{args.run_id}.json"
    summary_rel = f"book/experiments/runtime-final-final/suites/nonbaseline/MACF-wrapper/out/meta/{args.run_id}_summary.json"
