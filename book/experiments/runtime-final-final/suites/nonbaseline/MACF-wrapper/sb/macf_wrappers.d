...
/*
 * Runtime MACF wrapper logger for a single traced process.
 * Usage: sudo dtrace -q -s macf_wrappers.d -c "<command>"
 * Requires SIP disabled so that the fbt/syscall providers are available.
 * The generated script from capture.py should be preferred; this template
 * mirrors its structure for quick reference.
 */

inline string WORLD_ID = "sonoma-14.6.1-debug-vm";
inline string RUN_ID = "manual";
