...
Usage (example):
    python -m book.experiments.runtime_mac_policy.normalize \
        --raw book/experiments/runtime-final-final/suites/nonbaseline/runtime-mac_policy/out/raw/mac_policy.log \
        --out book/experiments/runtime-final-final/suites/nonbaseline/runtime-mac_policy/out/runtime_mac_policy_registration.json \
