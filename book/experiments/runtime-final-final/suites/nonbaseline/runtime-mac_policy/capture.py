...
def main() -> int:
    ...
    parser.add_argument(
        "--raw-out",
        default="book/experiments/runtime-final-final/suites/nonbaseline/runtime-mac_policy/out/raw/mac_policy.log",
        help="Path to write raw DTrace output.",
    )
    parser.add_argument(
        "--json-out",
        default="book/experiments/runtime-final-final/suites/nonbaseline/runtime-mac_policy/out/runtime_mac_policy_registration.json",
