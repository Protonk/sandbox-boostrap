...
python -m book.api.runtime run \
  --plan book/experiments/runtime-final-final/suites/runtime-closure/plan.json \
  --channel launchd_clean \
  --out book/experiments/runtime-final-final/suites/runtime-closure/out
```
...
The consolidated IOKit lane reference lives in `book/experiments/runtime-final-final/suites/runtime-closure/IOKIT.md` and records the current closure point: post-open IOSurface work still returns `kIOReturnBadArgument` in both baseline and sandbox, so it is not a sandbox gate claim at this stage. The summary table in that document points to the method-0 sweep (`book/experiments/runtime-final-final/suites/runtime-closure/out/iosurface_method0_sweep.json`), binary payload attempt (`book/experiments/runtime-final-final/suites/runtime-closure/out/iosurface_method0_binary.json`), v7 method-0 run (`book/experiments/runtime-final-final/suites/runtime-closure/out/289b183e-d86e-47db-ae57-0b9bd3541c6a/runtime_events.normalized.json`), and replay run (`book/experiments/runtime-final-final/suites/runtime-closure/out/e720b256-2f6e-4888-9288-2e19b5007fa9/runtime_events.normalized.json`).

## Failures ledger summary (Failures.md)
The negative knowledge from this experiment is captured in `book/experiments/runtime-final-final/suites/runtime-closure/Failures.md` and is meant to prevent re-running known dead ends. It highlights the method-0 selector sweep failure (`book/experiments/runtime-final-final/suites/runtime-closure/out/iosurface_method0_sweep.json`), the mach capture blind spot (`book/experiments/runtime-final-final/suites/runtime-closure/out/iosurface_mach_capture.json`), the apply-gated external-method profile (`book/experiments/runtime-final-final/suites/runtime-closure/out/03aaad16-f06b-4ec7-a468-c6379abbeb4d/mismatch_summary.json`), and the uncalibrated oracle lane (`book/experiments/runtime-final-final/suites/runtime-closure/out/0c49afaa-0739-4239-9275-eb875c6232da/runtime_events.normalized.json`).

## Seatbelt interfaces summary (Seatbelt_Interfaces.md)
The seatbelt interface map is documented in `book/experiments/runtime-final-final/suites/runtime-closure/Seatbelt_Interfaces.md` and explains how SBPL compilation/apply, operation-stage enforcement, oracle callouts, and observer logs are classified. It anchors the apply-gate boundary for `iokit-external-method` (same apply-gate run as above) and records the op vocabulary drift warning (`book/experiments/runtime-final-final/suites/runtime-closure/out/7deb2296-7fa8-48ea-849f-ac7a696f7c93/77c3c910-25d5-4499-9e5e-c70c570597ff/runtime_results.json`) as an interface-level signal, not a policy decision.
...
## Evidence & artifacts
- Runtime plan/registry: `book/experiments/runtime-final-final/suites/runtime-closure/plan.json` and `registry/{probes.json,profiles.json}`.
- SBPL profiles: `book/experiments/runtime-final-final/suites/runtime-closure/sb/*.sb`.
- Run bundles: `book/experiments/runtime-final-final/suites/runtime-closure/out/<run_id>/`.
  - File lane (v2 matrix): `book/experiments/runtime-final-final/suites/runtime-closure/out/ea704c9c-5102-473a-b942-e24af4136cc8/` (includes `path_witnesses.json` and `promotion_packet.json`).
  - File oracle calibration: `book/experiments/runtime-final-final/suites/runtime-closure/out/fe3745a4-1049-4a17-8246-0a29e5585d0e/`, `book/experiments/runtime-final-final/suites/runtime-closure/out/0c49afaa-0739-4239-9275-eb875c6232da/` (callouts deny all file targets).
  - Mach lane: `book/experiments/runtime-final-final/suites/runtime-closure/out/66315539-a0ce-44bf-bff0-07a79f205fea/`.
  - IOKit op-identity lane: `book/experiments/runtime-final-final/suites/runtime-closure/out/6ecc929d-fec5-4206-a85c-e3e265c349a7/`, `book/experiments/runtime-final-final/suites/runtime-closure/out/08887f36-f87b-45ff-8e9e-6ee7eb9cb635/`, `book/experiments/runtime-final-final/suites/runtime-closure/out/33ff5a68-262a-4a8c-b427-c7cb923a3adc/`, `book/experiments/runtime-final-final/suites/runtime-closure/out/fae371c2-f2f5-470f-b672-cf0c3e24d6c0/`, `book/experiments/runtime-final-final/suites/runtime-closure/out/bf996c2f-a265-4bb5-8c8a-105bd70af25a/`, `book/experiments/runtime-final-final/suites/runtime-closure/out/03aaad16-f06b-4ec7-a468-c6379abbeb4d/`, `book/experiments/runtime-final-final/suites/runtime-closure/out/ad767bba-9e59-40ff-b006-45fe911b2d02/`, `book/experiments/runtime-final-final/suites/runtime-closure/out/bf200589-b801-4771-8b73-a84dfef73be6/`, `book/experiments/runtime-final-final/suites/runtime-closure/out/f7b0ca74-c80b-4431-b0bc-9f1c97962e82/`, `book/experiments/runtime-final-final/suites/runtime-closure/out/6ed9e0b6-a2cf-4122-846e-c9c36eea52a0/`, `book/experiments/runtime-final-final/suites/runtime-closure/out/760494b1-5088-4271-ba05-50c3888c8690/`, `book/experiments/runtime-final-final/suites/runtime-closure/out/7edc2b2f-7edf-4a50-ba0c-bd9bb2a549d3/`, `book/experiments/runtime-final-final/suites/runtime-closure/out/7deb2296-7fa8-48ea-849f-ac7a696f7c93/`, `book/experiments/runtime-final-final/suites/runtime-closure/out/518f2e1d-66db-4392-89e8-4a74db154a82/`, `book/experiments/runtime-final-final/suites/runtime-closure/out/274a4c71-3c97-4aaa-a22f-93b587ba9ba9/`, `book/experiments/runtime-final-final/suites/runtime-closure/out/e720b256-2f6e-4888-9288-2e19b5007fa9/`.
- Call-shape trace: `book/experiments/runtime-final-final/suites/runtime-closure/out/iosurface_call_trace/iosurface_trace_stderr.txt`, `book/experiments/runtime-final-final/suites/runtime-closure/out/iosurface_call_trace/iosurface_trace_stdout.txt`, `book/experiments/runtime-final-final/suites/runtime-closure/out/iosurface_call_trace_2/iosurface_trace_stderr.txt`, `book/experiments/runtime-final-final/suites/runtime-closure/out/iosurface_call_trace_2/iosurface_trace_stdout.txt`.
  - Selector discovery (baseline): `book/experiments/runtime-final-final/suites/runtime-closure/out/a6e042e5-135d-4072-b0d6-50455abc62a3/iokit_probe_stdout.txt` and `book/experiments/runtime-final-final/suites/runtime-closure/out/a6e042e5-135d-4072-b0d6-50455abc62a3/iokit_probe_stderr.txt` using a WebKit-derived candidate list with non-zero call shapes.
  - Observer-lane logs: `book/experiments/runtime-final-final/suites/runtime-closure/out/bf996c2f-a265-4bb5-8c8a-105bd70af25a/observer/sandbox_log_stream_iokit.txt` and `book/experiments/runtime-final-final/suites/runtime-closure/out/bf996c2f-a265-4bb5-8c8a-105bd70af25a/observer/sandbox_log_show_iokit.txt` (no iokit op lines observed).
  - Prior runs: `book/experiments/runtime-final-final/suites/runtime-closure/out/5a8908d8-d626-4cac-8bdd-0f53c02af8fe/` (file v1) and `book/experiments/runtime-final-final/suites/runtime-closure/out/48086066-bfa2-44bb-877c-62dd1dceca09/` (IOKit v1).
