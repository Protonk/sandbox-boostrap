...
def main() -> int:
    ...
    parser.add_argument(
        "--out",
        default="book/experiments/runtime-final-final/suites/dtrace-testing/out/normalized/deny_signatures.json",
        help="Output JSON path.",
    )
    parser.add_argument(
        "--raw-smoke",
        default="book/experiments/runtime-final-final/suites/dtrace-testing/out/raw/smoke.jsonl",
        help="Raw smoke JSONL path.",
    )
    parser.add_argument(
        "--raw-idle",
        default="book/experiments/runtime-final-final/suites/dtrace-testing/out/raw/idle.jsonl",
        help="Raw idle JSONL path.",
    )
    parser.add_argument(
        "--raw-interaction",
        default="book/experiments/runtime-final-final/suites/dtrace-testing/out/raw/interaction.jsonl",
