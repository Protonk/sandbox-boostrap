...
- DTrace capture helper: `book/experiments/runtime-final-final/suites/dtrace-testing/capture.py`.
- Normalization helper: `book/experiments/runtime-final-final/suites/dtrace-testing/normalize.py`.
- Raw JSONL traces per phase in `book/experiments/runtime-final-final/suites/dtrace-testing/out/raw/`.
- Phase-keyed deny signatures in `book/experiments/runtime-final-final/suites/dtrace-testing/out/normalized/deny_signatures.json`.
- Entitlements witness artifacts in `book/experiments/runtime-final-final/suites/dtrace-testing/out/entitlements/`.
...
- Entitlements (codesign warnings; no blob emitted):
  - `book/experiments/runtime-final-final/suites/dtrace-testing/out/entitlements/EntitlementJail.app.entitlements.txt`
  - `book/experiments/runtime-final-final/suites/dtrace-testing/out/entitlements/ProbeService_debuggable.xpc.entitlements.txt`
- Entitlements (brittle string witness):
  - `book/experiments/runtime-final-final/suites/dtrace-testing/out/entitlements/ProbeService_debuggable.entitlements.strings.txt`
- Entitlements (runtime witness):
  - `book/experiments/runtime-final-final/suites/dtrace-testing/out/entitlements/ProbeService_debuggable.capabilities_snapshot.json`
  - `book/experiments/runtime-final-final/suites/dtrace-testing/out/entitlements/ProbeService_debuggable.capabilities_snapshot_smoke.json`
  - `book/experiments/runtime-final-final/suites/dtrace-testing/out/entitlements/ProbeService_debuggable.capabilities_snapshot_idle.json`
  - `book/experiments/runtime-final-final/suites/dtrace-testing/out/entitlements/ProbeService_debuggable.capabilities_snapshot_interaction.json`
- DTrace capture artifacts:
  - `book/experiments/runtime-final-final/suites/dtrace-testing/out/meta/dtrace_smoke.stderr`
  - `book/experiments/runtime-final-final/suites/dtrace-testing/out/meta/dtrace_idle.stderr`
  - `book/experiments/runtime-final-final/suites/dtrace-testing/out/meta/dtrace_interaction.stderr`
  - `book/experiments/runtime-final-final/suites/dtrace-testing/out/meta/smoke.json`
  - `book/experiments/runtime-final-final/suites/dtrace-testing/out/meta/idle.json`
  - `book/experiments/runtime-final-final/suites/dtrace-testing/out/meta/interaction.json`
  - `book/experiments/runtime-final-final/suites/dtrace-testing/out/raw/smoke.jsonl` (empty)
  - `book/experiments/runtime-final-final/suites/dtrace-testing/out/raw/idle.jsonl` (empty)
  - `book/experiments/runtime-final-final/suites/dtrace-testing/out/raw/interaction.jsonl` (empty)
- Normalized summary:
  - `book/experiments/runtime-final-final/suites/dtrace-testing/out/normalized/deny_signatures.json`
- Interaction outputs:
  - `book/experiments/runtime-final-final/suites/dtrace-testing/out/interaction/fs_op_stat.json`
  - `book/experiments/runtime-final-final/suites/dtrace-testing/out/interaction/fs_op_open_read.json`
  - `book/experiments/runtime-final-final/suites/dtrace-testing/out/interaction/fs_op_listdir.json`
- Non-system target (for PID-attach control):
  - `book/experiments/runtime-final-final/suites/dtrace-testing/targets/sleep_loop.c`
  - `book/experiments/runtime-final-final/suites/dtrace-testing/targets/sleep_loop`
  - `book/experiments/runtime-final-final/suites/dtrace-testing/out/meta/dtrace_non_system.json`
  - `book/experiments/runtime-final-final/suites/dtrace-testing/out/meta/dtrace_non_system.stderr`
  - `book/experiments/runtime-final-final/suites/dtrace-testing/out/meta/dtrace_non_system.stdout`
  - `book/experiments/runtime-final-final/suites/dtrace-testing/out/meta/dtrace_non_system_sudo.json`
  - `book/experiments/runtime-final-final/suites/dtrace-testing/out/meta/dtrace_non_system_sudo.stderr`
  - `book/experiments/runtime-final-final/suites/dtrace-testing/out/meta/dtrace_non_system_sudo.stdout`
...
- The non-system sudo run used a `sleep_loop` PID captured from the process launch; the PID is ephemeral but matches the intended target in `book/experiments/runtime-final-final/suites/dtrace-testing/out/meta/dtrace_non_system_sudo.json`.
