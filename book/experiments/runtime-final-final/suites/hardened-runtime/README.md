...
The run emits artifacts under `book/experiments/runtime-final-final/suites/hardened-runtime/out/<run_id>/` and updates `book/experiments/runtime-final-final/suites/hardened-runtime/out/LATEST`. Every JSON artifact carries a `schema_version`. The canonical entrypoint is the Artifact Index:
