...
## Evidence & artifacts
- SBPL sources: `book/experiments/runtime-final-final/suites/hardened-runtime/sb/*.sb`.
- Clean channel: `python -m book.api.runtime run --plan book/experiments/runtime-final-final/suites/hardened-runtime/plan.json --channel launchd_clean`.
- Plan template: `python -m book.api.runtime plan-build --template hardened-runtime --out book/experiments/runtime-final-final/suites/hardened-runtime --overwrite` (plan-build skips expected_matrix.json by default; use `--write-expected-matrix` for a static snapshot).
- Outputs: `book/experiments/runtime-final-final/suites/hardened-runtime/out/LATEST/` (see Deliverables).
- Runtime tooling inventory: `book/experiments/runtime-final-final/suites/hardened-runtime/other_runtime_inventory.json` (regenerated after probe migration to `book/api/runtime/native/probes`).
