...
python -m book.api.runtime run \
  --plan book/experiments/runtime-final-final/suites/lifecycle-lockdown/plan.json \
  --channel launchd_clean \
  --out book/experiments/runtime-final-final/suites/lifecycle-lockdown/out/runtime/launchd_clean_enforce
```

## Open questions

See `book/experiments/runtime-final-final/suites/lifecycle-lockdown/Plan.md`.

## Evidence (expected locations)

- Entitlements cross-check outputs under `book/experiments/runtime-final-final/suites/lifecycle-lockdown/out/entitlements/`
- Apply cross-check outputs under `book/experiments/runtime-final-final/suites/lifecycle-lockdown/out/apply/`
- Execution-lane isolation runtime bundles under `book/experiments/runtime-final-final/suites/lifecycle-lockdown/out/runtime/`
...
Evidence:
- `book/experiments/runtime-final-final/suites/lifecycle-lockdown/out/entitlements/summary.json`
- `book/experiments/runtime-final-final/suites/lifecycle-lockdown/out/entitlements/entitlements_unsigned.json`
- `book/experiments/runtime-final-final/suites/lifecycle-lockdown/out/entitlements/entitlements_signed.json`
- `book/experiments/runtime-final-final/suites/lifecycle-lockdown/out/entitlements/codesign_entitlements_signed.stdout.txt`
...
Evidence:
- `book/experiments/runtime-final-final/suites/lifecycle-lockdown/out/apply/summary.json`
- `book/experiments/runtime-final-final/suites/lifecycle-lockdown/out/apply/api_apply_attempt_passing.json`
- `book/experiments/runtime-final-final/suites/lifecycle-lockdown/out/apply/api_apply_attempt_gate.json`
- `book/experiments/runtime-final-final/suites/lifecycle-lockdown/out/apply/wrapper_sbpl_passing.stderr.txt`
- `book/experiments/runtime-final-final/suites/lifecycle-lockdown/out/apply/wrapper_sbpl_gate_force.stderr.txt`
- `book/experiments/runtime-final-final/suites/lifecycle-lockdown/out/apply/wrapper_blob_gate_force.stderr.txt`
...
Runtime note: baseline lane is now enabled as a reachability sanity lane (`baseline_results.json`); oracle lane remains disabled in `book/experiments/runtime-final-final/suites/lifecycle-lockdown/plan.json`.
...
Evidence:
- `book/experiments/runtime-final-final/suites/lifecycle-lockdown/out/runtime/launchd_clean_enforce/8d20c8f6-6ed3-4ca6-b0bd-da17599b18a9/runtime_results.json`
- `book/experiments/runtime-final-final/suites/lifecycle-lockdown/out/runtime/launchd_clean_force/4406014b-65cc-4753-a550-1200d966734d/runtime_results.json`
...
Evidence:
- Runtime bundle (preflight enforce): `book/experiments/runtime-final-final/suites/lifecycle-lockdown/out/runtime/launchd_clean_enforce/7ff2530c-ce4f-44d9-a43f-da3383a7984b/runtime_results.json`
- Generated SBPL (showing `process-exec*` + no `file-read*` for `/private/tmp`): `book/experiments/runtime-final-final/suites/lifecycle-lockdown/out/runtime/launchd_clean_enforce/7ff2530c-ce4f-44d9-a43f-da3383a7984b/runtime_profiles/passing_neighbor.lockdown_airlock_passing_sbpl.runtime.sb`
- Same, with `(allow file-write-data)`: `book/experiments/runtime-final-final/suites/lifecycle-lockdown/out/runtime/launchd_clean_enforce/7ff2530c-ce4f-44d9-a43f-da3383a7984b/runtime_profiles/passing_neighbor.lockdown_airlock_passing_sbpl_write.runtime.sb`
- Same, with added `file-map-executable` (no change observed): `book/experiments/runtime-final-final/suites/lifecycle-lockdown/out/runtime/launchd_clean_enforce/7ff2530c-ce4f-44d9-a43f-da3383a7984b/runtime_profiles/passing_neighbor.lockdown_airlock_passing_sbpl_write_mapexec.runtime.sb`
- Same, with added `file-read*` for `/private/tmp/sandbox-lore-launchctl` (no change observed): `book/experiments/runtime-final-final/suites/lifecycle-lockdown/out/runtime/launchd_clean_enforce/f2118065-6f7c-4445-9006-63b01240034b/runtime_profiles/passing_neighbor.lockdown_airlock_passing_sbpl_write_read_launchctl.runtime.sb`
- Runtime bundle showing `execvp()` `EPERM` persists under `..._write_read_launchctl`: `book/experiments/runtime-final-final/suites/lifecycle-lockdown/out/runtime/launchd_clean_enforce/f2118065-6f7c-4445-9006-63b01240034b/runtime_results.json`
...
Evidence:
- Runtime bundle (preflight enforce): `book/experiments/runtime-final-final/suites/lifecycle-lockdown/out/runtime/launchd_clean_enforce/d4e96281-6046-4405-81de-535fd29e8890/runtime_results.json`
- Generated SBPL for sysctl probe (shows `process-exec*` + `file-read*` on `/usr` + `file-write-data`): `book/experiments/runtime-final-final/suites/lifecycle-lockdown/out/runtime/launchd_clean_enforce/d4e96281-6046-4405-81de-535fd29e8890/runtime_profiles/passing_neighbor.lockdown_airlock_passing_sbpl_write_sysctl.runtime.sb`
- Same, with expanded `file-map-executable` allowlist (no change observed): `book/experiments/runtime-final-final/suites/lifecycle-lockdown/out/runtime/launchd_clean_enforce/d4e96281-6046-4405-81de-535fd29e8890/runtime_profiles/passing_neighbor.lockdown_airlock_passing_sbpl_write_mapexec_sysctl.runtime.sb`
...
- Runtime bundle: `book/experiments/runtime-final-final/suites/lifecycle-lockdown/out/runtime/launchd_clean_enforce/6629c56b-2729-4cc0-be08-5d3a6b7be0a2/runtime_results.json`
- Generated SBPL (`(allow default)` appended): `book/experiments/runtime-final-final/suites/lifecycle-lockdown/out/runtime/launchd_clean_enforce/6629c56b-2729-4cc0-be08-5d3a6b7be0a2/runtime_profiles/passing_neighbor.lockdown_airlock_passing_sbpl_write_allow_default_sysctl.runtime.sb`

Evidence (file_probe runs and yields operation-stage evidence under `(allow default)`):
- Runtime bundle: `book/experiments/runtime-final-final/suites/lifecycle-lockdown/out/runtime/launchd_clean_enforce/be733a4a-1903-4028-bad7-80f07ecd18ef/runtime_results.json`
- Generated SBPL (`(allow default)` appended): `book/experiments/runtime-final-final/suites/lifecycle-lockdown/out/runtime/launchd_clean_enforce/be733a4a-1903-4028-bad7-80f07ecd18ef/runtime_profiles/passing_neighbor.lockdown_airlock_passing_sbpl_write_allow_default_fileprobe.runtime.sb`

Negative controls (selected): `file-map-executable` (even unfiltered), `mach-lookup` (unfiltered), `file-read*` (unfiltered), and several path-scoped expansions did not clear the `execvp()` `EPERM`; see bundles under `book/experiments/runtime-final-final/suites/lifecycle-lockdown/out/runtime/launchd_clean_enforce/` with plan_ids `lifecycle-lockdown.v4.exec-stage-system-binary-pivot` through `lifecycle-lockdown.v14.exec-stage-codesigning`.
...
Evidence:
- Runtime bundle (apply fails): `book/experiments/runtime-final-final/suites/lifecycle-lockdown/out/runtime/launchd_clean_enforce/b8557b5d-fa11-40c5-bcb6-72cda15a61f7/runtime_results.json`
...
Evidence:
- Narrow variant bundle (process-exec*, mach-bootstrap/register, file-ioctl): `book/experiments/runtime-final-final/suites/lifecycle-lockdown/out/runtime/launchd_clean_enforce/ebd53423-8af4-4841-9dd9-1133fea07a9b/runtime_results.json`
- `file-search` / `file-test-existence` variants: `book/experiments/runtime-final-final/suites/lifecycle-lockdown/out/runtime/launchd_clean_enforce/2c77975f-808c-47b5-a92a-9beda16f2f1d/runtime_results.json`
- `process-exec` (no `*`) variant: `book/experiments/runtime-final-final/suites/lifecycle-lockdown/out/runtime/launchd_clean_enforce/a36ce479-765f-4e3d-9102-863225f7d6d3/runtime_results.json`
...
Evidence:
- Allow-default deny scan v1: `book/experiments/runtime-final-final/suites/lifecycle-lockdown/out/runtime/launchd_clean_enforce/52401592-67fb-473e-af25-f9217d21a925/runtime_results.json`
- Allow-default deny scan v2 (legacy codesigning): `book/experiments/runtime-final-final/suites/lifecycle-lockdown/out/runtime/launchd_clean_enforce/81b5ae10-79c6-4db5-a3a8-524d6fca9d3f/runtime_results.json`
