...
```sh
python3 book/experiments/runtime-final-final/suites/lifecycle-lockdown/run_lockdown.py --out book/experiments/runtime-final-final/suites/lifecycle-lockdown/out
```
...
SANDBOX_LORE_PREFLIGHT_FORCE=1 python3 -m book.api.runtime run \
  --plan book/experiments/runtime-final-final/suites/lifecycle-lockdown/plan.json \
  --channel launchd_clean \
  --out book/experiments/runtime-final-final/suites/lifecycle-lockdown/out/runtime/launchd_clean_force
```
