...
GATE_SBPL_DEFAULT = Path("book/experiments/runtime-final-final/suites/gate-witnesses/out/witnesses/airlock/minimal_failing.sb")
ADHOC_ENTITLEMENTS = Path("book/experiments/runtime-final-final/suites/lifecycle-lockdown/entitlements/none.plist")
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    ap.add_argument("--out", type=Path, default=DEFAULT_OUT, help="Output directory (default: book/experiments/runtime-final-final/suites/lifecycle-lockdown/out)")
    ap.add_argument(
        "--gate-sbpl",
        type=Path,
