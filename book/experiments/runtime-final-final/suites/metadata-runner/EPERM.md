...
2) Build and run the matrix:
   - `python3 book/experiments/runtime-final-final/suites/metadata-runner/run_metadata.py`
...
- Structural anchor checks moved to `book/experiments/field2-final-final/metadata-runner/` (field2-focused).
