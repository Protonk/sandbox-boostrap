...
- Unified runtime CLI run: `launchd_clean` bootstrap failed (launchctl exit 5); direct channel run succeeded and produced a committed bundle under `book/experiments/runtime-final-final/suites/metadata-runner/out/<run_id>/`.
