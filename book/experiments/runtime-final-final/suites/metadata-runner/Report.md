...
- Keep metadata canonicalization evidence separate from data read/write behavior (see `book/experiments/runtime-final-final/suites/vfs-canonicalization/Report.md`).
...
python -m book.api.runtime run \
  --plan book/experiments/runtime-final-final/suites/metadata-runner/plan.json \
  --channel launchd_clean \
  --out book/experiments/runtime-final-final/suites/metadata-runner/out
```
...
python -m book.api.runtime emit-promotion \
  --bundle book/experiments/runtime-final-final/suites/metadata-runner/out/LATEST \
  --out book/experiments/runtime-final-final/suites/metadata-runner/out/promotion_packet.json
```
...
## Evidence & artifacts
- Plan: `book/experiments/runtime-final-final/suites/metadata-runner/plan.json`.
- Registry: `book/experiments/runtime-final-final/suites/metadata-runner/registry/probes.json`, `book/experiments/runtime-final-final/suites/metadata-runner/registry/profiles.json`.
- Runtime bundle authority: `book/experiments/runtime-final-final/suites/metadata-runner/out/<run_id>/artifact_index.json`.
- Normalized events: `book/experiments/runtime-final-final/suites/metadata-runner/out/<run_id>/runtime_events.normalized.json`.
- Raw results: `book/experiments/runtime-final-final/suites/metadata-runner/out/<run_id>/runtime_results.json`.
- SBPL sources: `book/experiments/runtime-final-final/suites/metadata-runner/sb/metadata_*.sb`.
- Optional promotion packet: `book/experiments/runtime-final-final/suites/metadata-runner/out/promotion_packet.json`.
