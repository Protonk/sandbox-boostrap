...
- Packet emission:
  - `python -m book.api.runtime emit-promotion --bundle <suite>/out/LATEST --out book/experiments/runtime-final-final/evidence/packets/<suite>.promotion_packet.json`
- Derived outputs:
