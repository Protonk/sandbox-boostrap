...
- Outputs (this suite): derived summary + verdicts + counterexamples under `book/experiments/graph-shape-vs-semantics/out/derived/<run_id>/` with a stamped consumption receipt, generated by `summarize_struct_variants.py`.
