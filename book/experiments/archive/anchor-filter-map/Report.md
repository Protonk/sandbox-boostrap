...
- Inputs:
  ...
  - Field2 inventory (with anchors) from `book/experiments/field2-final-final/field2-filters/out/field2_inventory.json`.
...
- For a field2-first, runtime-tagged slice (field2 0/5/7 + a static-only candidate), see `book/experiments/field2-final-final/field2-atlas/`, which follows field2 as the primary key across anchors, profiles, and runtime traces.
