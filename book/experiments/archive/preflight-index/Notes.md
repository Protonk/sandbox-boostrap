...
- Expanded the SBPL inventory to include `book/experiments/**/*.sb` (excluding `out/`) and `book/examples/**/*.sb`, then regenerated via `python3 book/tools/preflight/build_index.py`.
