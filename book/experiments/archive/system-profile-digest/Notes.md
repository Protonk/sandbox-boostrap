...
- Generated digests for canonical system profiles (`airlock`, `bsd`, `sample`) with `book.api.profile.digests` (decoder-backed), sourced from `book/graph/concepts/validation/fixtures/blobs/{airlock,bsd,sample}.sb.bin`.
