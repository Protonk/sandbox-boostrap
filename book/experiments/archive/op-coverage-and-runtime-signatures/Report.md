...
> Archived experiment scaffold. Canonical mapping: `book/graph/mappings/runtime/op_runtime_summary.json`.

## Purpose

This suite keeps a per-operation runtime summary aligned with the canonical promotion pipeline for this world (`world_id sonoma-14.4.1-23E224-arm64-dyld-2c0602c5`). The canonical output is `book/graph/mappings/runtime/op_runtime_summary.json` (mapped); this experiment no longer owns summarization logic.
