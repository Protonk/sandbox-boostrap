...
- Ran sandbox_extension update_file_rename_delta with external rename on a Desktop harness file; captured witness at book/experiments/entitlement-jail-extension-semantics/out/witnesses/ej_update_file_rename_delta.json.
...
- Ran deterministic negative control with destination preexisting (dest_preexisted) to force early harness exit; captured witness at book/experiments/entitlement-jail-extension-semantics/out/witnesses/ej_update_file_rename_delta_dest_exists.json.
...
- Command:
  ...
  ```
- Ran EntitlementJail evidence snapshot (bundle-evidence + verify-evidence); outputs under book/experiments/entitlement-jail-extension-semantics/out/evidence/entitlementjail.
- Command:
  ```
  EJ="/Users/achyland/Desktop/entitlement-jail/EntitlementJail.app/Contents/MacOS/entitlement-jail"
  out_dir="book/experiments/entitlement-jail-extension-semantics/out/evidence/entitlementjail"
  mkdir -p "$out_dir"
