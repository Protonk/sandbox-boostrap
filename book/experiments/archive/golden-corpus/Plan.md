...
2. Run decoder and `book.api.profile` inspectors on each blob; store raw header/section slices and decoded JSON in `book/graph/concepts/validation/golden_corpus/`.
