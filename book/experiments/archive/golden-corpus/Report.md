...
- `book/graph/concepts/validation/golden_corpus/inspect/` – profile_tools inspect and op-table summaries per blob.
...
- `book/graph/concepts/validation/golden_corpus/inspect/*_inspect.json` and `*_op_table.json` – profile_tools summaries.
