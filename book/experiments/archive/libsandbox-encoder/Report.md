...
- Out of scope:
  ...
  - Kernel-side interpretation of the blob (tracked elsewhere; see `book/experiments/field2-final-final/field2-filters/Report.md`).
...
- Refresh Phase A matrices (recompiles `sb/matrix_v1.sb` and `sb/matrix_v2.sb` and rewrites `out/matrix_v*_field2_encoder_matrix.json`):
  - `python3 book/experiments/field2-final-final/libsandbox-encoder/run_phase_a.py`
- Refresh Phase A network arg matrix (recompiles `sb/network_matrix/*.sb` and rewrites `out/network_matrix/*`):
  - `python3 book/experiments/field2-final-final/libsandbox-encoder/run_network_matrix.py`
  - `python3 book/experiments/field2-final-final/libsandbox-encoder/diff_network_matrix.py`
  - `python3 book/experiments/field2-final-final/libsandbox-encoder/join_network_matrix.py`
  - `python3 book/experiments/field2-final-final/libsandbox-encoder/analyze_network_join.py`
  - `python3 book/experiments/field2-final-final/libsandbox-encoder/check_network_join.py`
  - `python3 book/experiments/field2-final-final/libsandbox-encoder/oracle_network_matrix.py` (HISTORICAL)
  - `python3 book/tools/sbpl/oracles/network_matrix.py --manifest book/experiments/field2-final-final/libsandbox-encoder/sb/network_matrix/MANIFEST.json --blob-dir book/experiments/field2-final-final/libsandbox-encoder/out/network_matrix --out book/experiments/field2-final-final/libsandbox-encoder/out/network_matrix/oracle_tuples.json` (maintained oracle)
