...
## Inputs
- SBPL profiles under `book/experiments/probe-op-structure/sb/`:
...
## Outputs
- `book/experiments/probe-op-structure/plan.json`
- `book/experiments/probe-op-structure/registry/{profiles,probes}.json`
- Runtime artifacts under `book/experiments/probe-op-structure/out/`
