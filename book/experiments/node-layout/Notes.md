...
- Baseline blob: `book/graph/concepts/validation/fixtures/blobs/sample.sb.bin` (583 bytes). Heuristic slices:
...
- Field2-focused node-field analysis moved to `book/experiments/field2-final-final/` to centralize field2 work.
