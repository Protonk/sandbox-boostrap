...
- Plan/registry files are now generated from the runtime_tools template: `python -m book.api.runtime_tools plan-build --template runtime-adversarial --out book/experiments/runtime-adversarial --overwrite`.
