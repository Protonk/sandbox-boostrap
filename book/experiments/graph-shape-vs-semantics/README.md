...
- IR path: artifacts in `out/` compared against current tag-layout assumptions (`book/graph/mappings/tag_layouts/tag_layouts.json`) and decoder expectations; informs whether reconstruction rules capture the right semantics.
