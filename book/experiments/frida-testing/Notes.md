...
- Action: moved the EntitlementJail Frida harness into book/api/entitlementjail/frida.py; book/experiments/frida-testing/run_ej_frida.py now delegates to the API entrypoint.
