...
CONTROL_PATH = Path("book/experiments/field2-final-final/probe-op-structure/sb/build/v12_iokit_control.sb.bin")
VARIANT_PATH = Path("book/experiments/field2-final-final/probe-op-structure/sb/build/v9_iokit_user_client_only.sb.bin")
OUT_PATH = Path("book/experiments/field2-final-final/probe-op-structure/out/anchor_hits_delta.json")
