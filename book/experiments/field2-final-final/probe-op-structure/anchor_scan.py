...
def main() -> None:
    ...
    anchors_map = json.loads(Path("book/experiments/field2-final-final/probe-op-structure/anchor_map.json").read_text())
    profiles_dir = Path("book/experiments/field2-final-final/probe-op-structure/sb/build")
