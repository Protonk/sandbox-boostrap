...
def main() -> None:
    ...
    probes_dir = Path("book/experiments/field2-final-final/field2-filters/sb/build")
    ...
    probe_op_dir = Path("book/experiments/field2-final-final/probe-op-structure/sb/build")
    ...
    anchor_hits_path = Path("book/experiments/field2-final-final/probe-op-structure/out/anchor_hits.json")
    ...
    out_dir = Path("book/experiments/field2-final-final/field2-filters/out")
