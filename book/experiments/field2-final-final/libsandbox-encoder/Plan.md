...
- Phase A (network arg matrix): implemented; see `python3 book/experiments/field2-final-final/libsandbox-encoder/run_network_matrix.py` + `python3 book/experiments/field2-final-final/libsandbox-encoder/diff_network_matrix.py`.
