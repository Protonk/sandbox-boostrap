...
def load_manifest_cases() -> List[Dict[str, Any]]:
    manifest_path = ROOT / "book/experiments/field2-final-final/libsandbox-encoder/sb/network_matrix/MANIFEST.json"
...
def main() -> None:
    ...
    out = {
        ...
        "inputs": {
            "manifest": rel(ROOT / "book/experiments/field2-final-final/libsandbox-encoder/sb/network_matrix/MANIFEST.json"),
        },
