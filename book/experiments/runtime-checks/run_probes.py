#!/usr/bin/env python3
"""
Deprecated wrapper: run runtime-checks via runtime_tools plan execution.
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run runtime-checks via runtime_tools plan.")
