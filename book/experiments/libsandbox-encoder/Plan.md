...
- Phase A (network arg matrix): implemented; see `python3 book/experiments/libsandbox-encoder/run_network_matrix.py` + `python3 book/experiments/libsandbox-encoder/diff_network_matrix.py`.
